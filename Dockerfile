...
RUN mkdir -p /app/data/by_detection_month /app/data/by_source /app/data/blacklist_ips /app/data/exports /app/data/logs /app/data/regtech /app/data/secudium /app/temp \
    && chown -R app:app /app
