...
(function(N, a) {
    ...
    N = function() {
        var a = window,
            ...
            w = !E,
            k = /Firefox/.test(A),
            l = k && 4 > parseInt(A.split("Firefox/")[1], 10);
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            dSetter: function() {
                var a = this.paths[0],
                    ...
                    h;
                if (1 === r) l = this.toD;
                else if (q === k.length && 1 > r)
                    for (; q--;) h = parseFloat(a[q]), l[q] = isNaN(h) ? a[q] : r * parseFloat(k[q] - h) + h;
                else l = k;
                this.elem.attr("d", l)
            },
            update: function() {
        ...
        a.attr = function(w, k, l) {
            var r, q;
            if (a.isString(k)) a.defined(l) ? w.setAttribute(k, l) : w && w.getAttribute && (q = w.getAttribute(k));
            else if (a.defined(k) && a.isObject(k))
                for (r in k) w.setAttribute(r, k[r]);
            return q
        };
        a.splat = function(w) {
        ...
        a.pick = function() {
            var a = arguments,
                k, l, r = a.length;
            for (k = 0; k < r; k++)
                if (l = a[k], void 0 !== l && null !== l) return l
        };
        a.css = function(w, k) {
        ...
        a.dateFormat = function(w, k, l) {
            ...
            for (h in r)
                for (; - 1 !== w.indexOf("%" + h);) w = w.replace("%" + h, "function" === typeof r[h] ? r[h](k) : r[h]);
        ...
        a.numberFormat = function(w, k, l, r) {
            ...
            var q = a.defaultOptions.lang,
                h = (w.toString().split(".")[1] || "").length,
                n, c, g = Math.abs(w); - 1 === k ? k = Math.min(h, 20) : a.isNumber(k) || (k = 2);
        ...
        a.removeEvent = function(w, k, l) {
            ...
            function q() {
                var a, c;
                if (w.nodeName)
                    for (c in k ? (a = {}, a[k] = !0) : a = n, a)
                        if (n[c])
                            for (a = n[c].length; a--;) r(c, n[c][a])
            }
            var h, n = w.hcEvents,
                c;
        ...
        a.fireEvent = function(w, k, l, r) {
            ...
            var h, n;
            l = l || {};
            if (E.createEvent && (w.dispatchEvent || w.fireEvent)) q = E.createEvent("Events"), q.initEvent(k, !0, !0), a.extend(q, l), w.dispatchEvent ? w.dispatchEvent(q) : w.fireEvent(k, q);
            else if (q)
                for (q = q[k] || [], h = q.length, l.target || a.extend(l, {
        ...
        a.seriesType = function(w, k, l, r, q) {
            ...
            n[w] = a.extendClass(n[k] || function() {}, r);
        ...
        Array.prototype.forEach || (a.each = function(a, k, l) {
            for (var r = 0, q = a.length; r < q; r++)
                if (!1 === k.call(l, a[r], r, a)) return r
        });
        ...
        a.Color.prototype = {
            ...
            init: function(k) {
                ...
                if ((this.input = k = this.names[k] || k) && k.stops) this.stops = E(k.stops, function(h) {
                    ...
                    for (q = this.parsers.length; q-- && !r;) h = this.parsers[q], (l = h.regex.exec(k)) && (r = h.parse(l));
                this.rgba = r || []
            },
            get: function(a) {
                var l = this.input,
            ...
            brighten: function(a) {
                ...
                if (this.stops) C(this.stops, function(q) {
                    ...
                    for (l = 0; 3 > l; l++) k[l] += w(255 * a), 0 > k[l] && (k[l] = 0), 255 < k[l] && (k[l] = 255);
                return this
            },
    ...
    (function(a) {
        ...
        C.prototype = {
            ...
            colorGradient: function(B, d, u) {
                ...
                if (e) {
                    ...
                    "radialGradient" === e && v && !h(f.gradientUnits) && (J = f, f = y(f, L.getRadialAttr(v, J), {
                        gradientUnits: "userSpaceOnUse"
                    }));
            ...
            applyTextShadow: function(a) {
                var B = this.element,
                    u, b = -1 !== a.indexOf("contrast"),
                    e = {},
                    f = this.renderer.forExport,
                    J = this.renderer.forExport || void 0 !== B.style.textShadow && !d;
            ...
            attr: function(a, d, u) {
                ...
                if ("string" === typeof a) e = (this[a + "Getter"] || this._defaultGetter).call(this, a, L);
                else {
            ...
            css: function(a) {
                ...
                if (B)
                    for (J in a) a[J] !== B[J] && (b[J] = a[J], f = !0);
                if (f) {
        ...
        A.prototype = {
                    ...
                    v = /<.*href="(http[^"]+)".*>/, O && O.appendChild(d), f = c ? f.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [f], f = e(f, function(a) {
                        ...
                        m(c, function(e) {
                            if ("" !== e || 1 === c.length) {
                                ...
                                v.test(e) && !B && (w(L, "onclick", 'location.href\x3d"' + e.match(v)[1] + '"'), r(L, {
                                    cursor: "pointer"
                                }));
                                ...
                                if (" " !== e) {
                                    ...
                                    if (z) {
                                        ...
                                        for (var Q = 1 < c.length || f || 1 < x.length && !m, n, I, P = [], O = q(L), l = a.rotation, K = e, k = K.length;
                                            (Q || M) && (x.length || P.length);) a.rotation = 0, n = a.getBBox(!0), I = n.width, !u && b.forExport && (I = b.measureSpanWidth(L.firstChild.data, a.styles)), n = I > z, void 0 === y && (y = n), M && y ? (k /= 2, "" === K || !n && .5 > k ? x = [] : (K = e.substring(0, K.length + (n ? -1 : 1) * Math.ceil(k)), x = [K + (3 < z ? "\u2026" : "")], L.removeChild(L.firstChild))) : n && 1 !== x.length ? (L.removeChild(L.firstChild),
            ...
            button: function(a,
                u, b, e, f, J, c, p, t) {
                var B = this.label(a, u, b, t, null, null, null, null, "button"),
                    L = 0;
                B.attr(y({
                    padding: 8,
                    r: 2
            ...
            arc: function(a, d, u, b, e, f) {
                ...
                a = this.symbol("arc", a || 0, d || 0, u || 0, u || 0, {
                    innerR: b || 0,
                    start: e || 0,
                    end: f || 0
                });
            ...
            symbol: function(a, d, u, b, e, f) {
                var J = this,
                    c, p = this.symbols[a],
                    B = h(d) && p && p(Math.round(d), Math.round(u),
                        b, e, f),
                    t = /^url\((.*?)\)$/,
                    x, L;
            ...
            text: function(a, d, b, e) {
                ...
                e || (a.xSetter = function(a, d, u) {
                    var b = u.getElementsByTagName("tspan"),
                        e, f = u.getAttribute(d),
                        c;
            ...
            label: function(a, d, u, b, e, f, c, J, p) {
                var x = this,
                    t = x.g("button" !== p && "label"),
                    g = t.text = x.text("", 0, 0, c).attr({
                        zIndex: 1
                    }),
                    v, F, G = 0,
                    B = 3,
    ...
    (function(a) {
        ...
        k(a.SVGElement.prototype, {
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === c.tagName) {
                        var t = this.rotation,
                            v = h(this.textWidth),
                            y = F && F.whiteSpace,
                            n = [t, g, c.innerHTML, this.textWidth, this.textAlign].join();
            ...
            setSpanRotation: function(a,
                g, f) {
                var e = {},
                    b = r ? "-ms-transform" : q ? "-webkit-transform" : l ? "MozTransform" : c.opera ? "-o-transform" : "";
    ...
    (function(a) {
        ...
        a.svg || (A = {
                ...
                getSpanCorrection: function(a, b, e, c, p) {
                    var d = c ? Math.cos(c * k) : 1,
                        g = c ? Math.sin(c * k) : 0,
                        t = f(this.elemHeight, this.element.offsetHeight),
                        D;
                    this.xCorr =
                        0 > d && -a;
                    this.yCorr = 0 > g && -t;
                    ...
                    p && "left" !== p && (this.xCorr -= a * e * (0 > d ? -1 : 1), c && (this.yCorr -= t * e * (0 > g ? -1 : 1)), H(this.element, {
                        textAlign: p
                    }))
                },
                ...
                dSetter: function(a, b, e) {
                    ...
                    if (d)
                        for (e = d.length; e--;) d[e].path = d[e].cutOff ? this.cutOffPath(a, d[e].cutOff) : a;
                    this.setAttr(b, a)
                },
            ...
            A.prototype.xSetter, A = {
                    ...
                    return n(d, {
                        ...
                        getCSS: function(a) {
                            var d = a.element,
                                b = d.nodeName,
                                e = a.inverted,
                                u = this.top - ("shape" === b ? d.offsetTop : 0),
                                f = this.left,
                                d = f + this.width,
                                c = u + this.height,
                                u = {
                ...
                color: function(d, b, e, f) {
                    ...
                    if (D) {
                        var u, J, v = d.linearGradient || d.radialGradient,
                            m, B, L, h, F, n = "";
                        d = d.stops;
                        var z, l = [],
                            k = function() {
                        ...
                        if ("fill" === e)
                            if ("gradient" === D) e = v.x1 || v[0] || 0, d = v.y1 || v[1] || 0, m = v.x2 || v[2] || 0, v = v.y2 || v[3] || 0, n = 'angle\x3d"' + (90 - 180 * Math.atan((v - d) / (m - e)) / Math.PI) + '"',
                                k();
                            else {
                                var t = v.r,
                                    K = 2 * t,
    ...
    (function(a) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                if (p) F = h.getPlotLinePath(e, k.strokeWidth());
                else if (b) F = h.getPlotBandPath(f, z, c);
                else return;
                if (d && F && F.length) {
                    if (k.attr({
                            d: F
                        }), I)
                        for (t in c = function(d) {
                                k.on(d, function(b) {
                                    I[d].apply(a, [b])
                                })
                            }, I) c(t)
                } else k && (F ? (k.show(), k.animate({
                    d: F
                })) : (k.hide(), m && (a.label = m = m.destroy())));
        ...
        a.AxisPlotLineOrBandExtension = {
            ...
            addPlotBandOrLine: function(k, h) {
                var n = (new a.PlotLineOrBand(this, k)).render(),
                    c = this.userOptions;
            ...
            removePlotBandOrLine: function(a) {
                ...
                w([n.plotLines || [], c.plotLines || [], n.plotBands || [], c.plotBands || []], function(c) {
    ...
    (function(a) {
        ...
        a.Tick.prototype = {
            addLabel: function() {
                ...
                A(c) ? c && c.attr({
                    text: h
                }) : (this.labelLength = (this.label = c = A(h) && z.enabled ? n.renderer.text(h, 0, 0, z.useHTML).css(w(z.style)).add(a.labelGroup) : null) && c.getBBox().width, this.rotation = 0)
            },
            ...
            handleOverflow: function(a) {
                var h = this.axis,
                    n = a.x,
                    c = h.chart.chartWidth,
                    g = h.chart.spacing,
                    m = k(h.labelLeft, Math.min(h.pos, g[3])),
                    g = k(h.labelRight, Math.max(h.pos + h.len, c - g[1])),
                    z = this.label,
                    f = this.rotation,
                    e = {
                        left: 0,
                    ...
                    d = 1,
                    F, t = {};
                if (f) 0 > f && n - e * b < m ? F = Math.round(n / Math.cos(f * r) - m) : 0 < f && n + e * b > g && (F = Math.round((c - n) / Math.cos(f * r)));
                else if (c = n + (1 - e) * b, n - e * b < m ? l = a.x + l * (1 - e) - m : c > g && (l = g - a.x + l * e, d = -1), l = Math.min(p,
            ...
            getPosition: function(a, h, n, c) {
                var g = this.axis,
                    m = g.chart,
                    z = c && m.oldChartHeight || m.chartHeight;
                return {
            ...
            render: function(a, h, n) {
                var c = this.axis,
                    ...
                    G = !0,
                    x = c.tickmarkOffset,
                    D = this.getPosition(z, b, x, h),
                    M = D.x,
                    D = D.y,
                    u = z && M === c.pos + c.len || !z && D === c.pos ? -1 : 1,
                    J = f ? f + "Grid" : "grid",
                    O = g[J + "LineWidth"],
                    Q = g[J + "LineColor"],
                    B = g[J + "LineDashStyle"],
                    J = k(g[d + "Width"], !f && c.isXAxis ? 1 : 0),
                    d = g[d + "Color"];
                n = k(n, 1);
                this.isActive = !0;
                K || (I.stroke =
    ...
    (function(a) {
        ...
        a.Axis.prototype = {
            ...
            init: function(a, d) {
                ...
                var f;
                d = this.options.events; - 1 === p(this, a.axes) && (b ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
            ...
            defaultLabelFormatter: function() {
                var d = this.axis,
                    ...
                    p = r.lang.numericSymbols,
                    g = p &&
                    p.length,
                    x, D = d.options.labels.format,
                    d = d.isLog ? b : d.tickInterval;
                if (D) x = f(D, this);
                else if (e) x = b;
                else if (c) x = a.dateFormat(c, b);
                else if (g && 1E3 <= d)
                    for (; g-- && void 0 === x;) e = Math.pow(1E3, g + 1), d >= e && 0 === 10 * b % e && null !== p[g] && 0 !== b && (x = a.numberFormat(b / e, -1) + p[g]);
                ...
                c(a.series, function(u) {
                    if (u.visible || !e.options.chart.ignoreHiddenSeries) {
                        ...
                        if (a.isXAxis) f = u.xData, f.length && (u = H(f), d(u) || u instanceof Date || (f = b(f, function(a) {
                            return d(a)
                        }), u = H(f)), a.dataMin = Math.min(y(a.dataMin, f[0]), u), a.dataMax = Math.max(y(a.dataMax, f[0]), E(f)));
                        else if (u.getExtremes(), p = u.dataMax, u = u.dataMin, q(u) && q(p) && (a.dataMin = Math.min(y(a.dataMin, u), u), a.dataMax = Math.max(y(a.dataMax, p), p)), q(c) &&
            ...
            getPlotLinePath: function(a, b, e, f, c) {
                var u = this.chart,
                    p = this.left,
                    J = this.top,
                    g, x, D = e && u.oldChartHeight || u.chartHeight,
                    t = e && u.oldChartWidth || u.chartWidth,
                    v;
                g = this.transB;
            ...
            getMinorTickPositions: function() {
                ...
                if (p && p / b < this.len / 3)
                    if (this.isLog)
                        for (c =
                            d.length, f = 1; f < c; f++) e = e.concat(this.getLogTickPositions(b, d[f - 1], d[f], !0));
                    else if (this.isDatetimeAxis && "auto" === a.minorTickInterval) e = e.concat(this.getTimeTicks(this.normalizeTimeTickInterval(b), f, c, a.startOfWeek));
                else
                    for (d = f + (d[0] - f) % b; d <= c; d += b) e.push(d);
            ...
            adjustForMinRange: function() {
                ...
                this.isXAxis && void 0 === this.minRange && !this.isLog &&
                    (q(a.min) || q(a.max) ? this.minRange = null : (c(this.series, function(a) {
                        D = a.xData;
                        for (g = t = a.xIncrement ? 1 : D.length - 1; 0 < g; g--)
                            if (x = D[g] - D[g - 1], void 0 === p || x < p) p = x
            ...
            nameToX: function(a) {
                var d = K(this.categories),
                    b = d ? this.categories : this.names,
                    e = a.options.x,
                    u;
                a.series.requireSorting = !1;
                q(e) || (e = !1 === this.options.uniqueNames ? a.series.autoIncrement() : p(a.name, b)); - 1 === e ? d || (u = b.length) : u = e;
                this.names[u] = a.name;
                return u
            },
            updateNames: function() {
                ...
                0 < this.names.length && (this.names.length = 0, this.minRange =
                    void 0, c(this.series || [], function(d) {
            ...
            trimTicks: function(a, b, d) {
                ...
                if (b) this.min = e;
                    ...
                    for (; this.min - u > a[0];) a.shift();
                if (d) this.max = f;
                else
                    for (; this.max + u < a[a.length - 1];) a.pop();
            ...
            zoom: function(a, b) {
                var d = this.dataMin,
                    e = this.dataMax,
                    f = this.options,
                    u = Math.min(d, y(f.min, d)),
                    f = Math.max(e, y(f.max, e));
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (q(d) && a <= u && (a = u), q(e) && b >= f && (b = f)), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
                    trigger: "zoom"
                });
                return !0
            },
            setAxisSize: function() {
                var a = this.chart,
                    ...
                    d = b.offsetLeft || 0,
                    e = this.horiz,
                    f = y(b.width, a.plotWidth - d + (b.offsetRight || 0)),
                    c = y(b.height, a.plotHeight),
                    p = y(b.top, a.plotTop),
                    b = y(b.left, a.plotLeft + d),
                    d = /%$/;
            ...
            getThreshold: function(a) {
                var b = this.isLog,
                    d = this.lin2log,
                    e = b ? d(this.min) : this.min,
                    b = b ? d(this.max) : this.max;
            ...
            renderUnsquish: function() {
                var a = this.chart,
                    ...
                    g = this.getSlotWidth(),
                    x = Math.max(1,
                        Math.round(g - 2 * (f.padding || 5))),
                    D = {},
                    v = this.labelMetrics(),
                    m = f.style && f.style.textOverflow,
                    y, G = 0,
                    h, n;
                ...
                if (this.autoRotation) G > x && G > v.h ? D.rotation = this.labelRotation : this.labelRotation = 0;
                else if (g && (y = {
                        width: x + "px"
                    }, !m))
                    for (y.textOverflow = "clip", h = d.length; !p && h--;)
                        if (n = d[h], x = e[n].label) x.styles && "ellipsis" === x.styles.textOverflow ? x.css({
                                textOverflow: "clip"
                            }) : e[n].labelLength >
                            g && x.css({
                                width: g + "px"
                            }), x.getBBox().height > this.len / d.length - (v.h - v.f) && (x.specCss = {
            ...
            getOffset: function() {
                ...
                a.axisGroup || (a.gridGroup =
                    ...
                    }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (r || "")).add(w), a.axisGroup = d.g("axis").attr({
                        zIndex: e.zIndex || 2
                    }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (r || "")).add(w), a.labelGroup = d.g("axis-labels").attr({
                        zIndex: z.zIndex || 7
                    }).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (r || "")).add(w));
                if (v || a.isLinked) c(f, function(b) {
                        p[b] ? p[b].addLabel() : p[b] = new M(a, b)
                    }), a.renderUnsquish(), !1 === z.reserveSpace || 0 !== x && 2 !== x && {
                        1: "left",
                        3: "right"
                    }[x] !==
                    ...
                    for (K in p) p[K].destroy(), delete p[K];
            ...
            getTitlePosition: function() {
                var a = this.horiz,
                    ...
                    x = f.x || 0,
                    D = f.y || 0,
                    v = this.chart.renderer.fontMetrics(f.style && f.style.fontSize, this.axisTitle).f,
                    e = {
                        low: c + (a ? 0 : e),
                        middle: c + e / 2,
                        high: c + (a ? e : 0)
                    }[f.align],
                    b = (a ? d + this.height : b) + (a ? 1 : -1) * (p ? -1 : 1) * this.axisTitleMargin + (2 === this.side ? v : 0);
                return {
            ...
            render: function() {
                var a =
                    ...
                    G = a.alternateBands,
                    h = f.stackLabels,
                    n = f.alternateGridColor,
                    z = a.tickmarkOffset,
                    F = a.axisLine,
                    l = b.hasRendered && d(a.oldMin),
                    k = a.showAxis,
                    K = A(e.globalAnimation),
                    r, q;
            ...
            drawCrosshair: function(a, b) {
                ...
                this.crosshair && !1 !== (q(b) || !f) ? (f ? q(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), q(c) && (d = this.getPlotLinePath(b && (this.isXAxis ? b.x : y(b.stackY, b.y)), null, null, null, c) || null), q(d) ? (b =
                    this.categories && !this.isRadial, p || (this.cross = p = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " : "thin ") + e.className).attr({
                        zIndex: y(e.zIndex, 2)
                    }).add(), p.attr({
    ...
    (function(a) {
        ...
        C.prototype.getLogTickPositions = function(a, l, r, q) {
            ...
            if (.5 <= a) a = Math.round(a), m = this.getLinearTickPositions(a, l, r);
            else if (.08 <= a)
                for (var n = Math.floor(l), z, f, e, b, p, h = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; n < r + 1 && !p; n++)
                    for (f = h.length, z = 0; z < f && !p; z++) e = g(c(n) * h[z]), e > l && (!q || b <= r) && void 0 !== b && m.push(b), b > r && (p = !0), b = e;
            else l = c(l), r = c(r), a = h[q ? "minorTickInterval" :
    ...
    (function(a) {
        ...
        a.Tooltip.prototype = {
            ...
            move: function(a, c, h, f) {
                var e = this,
                    b = e.now,
                    p = !1 !== e.options.animation && !e.isHidden && (1 < Math.abs(a - b.x) || 1 < Math.abs(c - b.y)),
            ...
            getPosition: function(a, c, h) {
                var f = this.chart,
                    ...
                    b = {},
                    p = h.h || 0,
                    g, d = ["y", f.chartHeight, c, h.plotY + f.plotTop, f.plotTop, f.plotTop + f.plotHeight],
                    m = ["x", f.chartWidth, a, h.plotX + f.plotLeft, f.plotLeft, f.plotLeft + f.plotWidth],
                    t = !this.followPointer && r(h.ttBelow, !f.inverted === !!h.negative),
                    v = function(a, d, f, c, g, v) {
                        var x = f < c - e,
                            u = c + e + f < d,
                            D = c - e - f;
                        c += e;
                        ...
                        else if (x) b[a] = Math.min(v - f, 0 > D - p ? D : D - p);
                        else if (u) b[a] = Math.max(g, c + p + f > d ? c : c + p);
                        else return !1
                    },
                    y = function(a, d, f, c) {
                        var p;
            ...
            refresh: function(a, c) {
                ...
                !t || a.series && a.series.noSharedTooltip ? m = a.getLabelConfig() : (g.hoverPoints = a, m && A(m, function(a) {
                    ...
                    m = {
                        x: a[0].category,
                        y: a[0].y
                    }, m.points = n, this.len = n.length, a = a[0]);
                d = d.call(m, this);
                m = a.series;
                this.distance = r(m.tooltipOptions.distance, 16);
                !1 === d ? this.hide() : (this.isHidden && (h(f), f.attr({
                    opacity: 1
                }).show()), this.split ? this.renderSplit(d, g.hoverPoints) : (f.attr({
                    text: d.join ? d.join("") : d
                }), f.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + r(a.colorIndex, m.colorIndex)), f.attr({
                    stroke: e.borderColor || a.color || m.color || "#666666"
                }), this.updatePosition({
                    plotX: c,
                    plotY: b,
                    negative: a.negative,
            ...
            renderSplit: function(c, m) {
                ...
                A(c.slice(0, c.length - 1), function(a, c) {
                    ...
                    var t = c.series || g,
                        v = t.tt,
                        G = c.series || {},
                        x = "highcharts-color-" + r(c.colorIndex, G.colorIndex, "none");
            ...
            tooltipFooterHeaderFormatter: function(a, c) {
                ...
                c = a.series;
                var f = c.tooltipOptions,
                    e = f.xDateFormat,
                    b = c.xAxis,
                    p = b && "datetime" === b.options.type && w(a.key),
                    g = f[g + "Format"];
        ...
        a.Pointer.prototype = {
            ...
            runPointActions: function(e) {
                ...
                if (!d && !v)
                    for (y = 0; y < f.length; y++)
                        if (f[y].directTouch || !f[y].options.stickyTracking) f = [];
                ...
                if (d)
                    for (y = x.length; y--;)(x[y].x !== x[0].x || x[y].series.noSharedTooltip) && x.splice(y, 1);
            ...
            drag: function(a) {
                var b = this.chart,
                    ...
                    h = b.plotWidth,
                    G = b.plotHeight,
                    x, D = this.selectionMarker,
                    n = this.mouseDownX,
                    u = this.mouseDownY,
                    l = e.panKey && a[e.panKey + "Key"];
            ...
            drop: function(a) {
                ...
                if (this.selectionMarker) {
                    var d = {
                        ...
                        g = c.attr ? c.attr("x") : c.x,
                        v = c.attr ? c.attr("y") : c.y,
                        m = c.attr ? c.attr("width") : c.width,
                        n = c.attr ? c.attr("height") :
                        c.height,
                        G;
                    if (this.hasDragged || f) r(e.axes, function(e) {
                        if (e.zoomEnabled && k(e.min) && (f || b[{
                                xAxis: "zoomX",
                                yAxis: "zoomY"
                            }[e.coll]])) {
                            var c = e.horiz,
                                p = "touchend" === a.type ? e.minPixelPadding : 0,
                                x = e.toValue((c ? g : v) + p),
                                c = e.toValue((c ? g + m : v + n) - p);
                            d[e.coll].push({
                                axis: e,
                                min: Math.min(x, c),
                                max: Math.max(x, c)
            ...
            onContainerClick: function(a) {
                var b = this.chart,
                    ...
                    d = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (e && this.inClass(a.target, "highcharts-tracker") ? (h(e.series, "click", q(a, {
                    point: e
                })), b.hoverPoint && e.firePointEvent("click", a)) : (q(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - f, a.chartY - d) && h(b, "click", a)))
            },
        ...
        E(a.Pointer.prototype, {
            ...
            pinch: function(a) {
                var l = this,
                    ...
                    f = {},
                    e = 1 ===
                    c && (l.inClass(a.target, "highcharts-tracker") && q.runTrackerClick || l.runChartClick),
                    b = {};
                1 < c && (l.initiated = !0);
            ...
            touch: function(l, r) {
                ...
                1 === l.touches.length ? (l = this.normalize(l), q.isInsidePlot(l.chartX - q.plotLeft, l.chartY - q.plotTop) &&
                    !q.openMenu ? (r && this.runPointActions(l), "touchmove" === l.type && (r = this.pinchDown, h = r[0] ? 4 <= Math.sqrt(Math.pow(r[0].chartX - l.chartX, 2) + Math.pow(r[0].chartY - l.chartY, 2)) : !1), k(h, !0) && this.pinch(l)) : r && this.reset()) : 2 === l.touches.length && this.pinch(l)
            },
        ...
        if (q.PointerEvent || q.MSPointerEvent) {
            var n = {},
                ...
                g = function() {
                    ...
                    for (a in n) n.hasOwnProperty(a) && f.push({
                        pageX: n[a].pageX,
                        pageY: n[a].pageY,
                        target: n[a].target
                    });
    ...
    (function(a) {
        ...
        C.prototype = {
            ...
            colorizeItem: function(a, e) {
                ...
                if (d) {
                    if (v && d.isMarker && (m = a.pointAttribs(), !e))
                        for (h in m) m[h] = g;
                    d.attr(m)
                }
            },
            ...
            renderItem: function(a) {
                var e = this.chart,
                    ...
                    z = a.legendItem,
                    q = !a.series,
                    r = !q && a.series.drawLegendSymbol ? a.series : a,
                    B = r.options,
                    B = this.createCheckboxForItem &&
                    B && B.showCheckbox,
                    L = c.useHTML;
                z || (a.legendGroup = b.g("legend-item").addClass("highcharts-" + r.type + "-series highcharts-color-" + a.colorIndex + " " + (a.options.className || "") + (q ? "highcharts-series-" + a.index : "")).attr({
                        zIndex: 1
                    }).add(this.scrollGroup), a.legendItem = z = b.text("", G ? d + g : -g, this.baseline || 0, L).css(h(a.visible ? m : v)).attr({
                        align: G ? "left" : "right",
                        zIndex: 2
            ...
            adjustMargins: function(a, e) {
                var b = this.chart,
                    c = this.options,
                    f = c.align.charAt(0) + c.verticalAlign.charAt(0) +
                    c.layout.charAt(0);
            ...
            render: function() {
                ...
                t += z;
                v || (a.box = v = b.rect().addClass("highcharts-legend-box").attr({
                        r: n.borderRadius
                    }).add(c),
                    v.isNew = !0);
                v.attr({
            ...
            handleOverflow: function(a) {
                var e = this,
                    ...
                    f = this.options,
                    d = f.y,
                    d = b.spacingBox.height +
                    ("top" === f.verticalAlign ? -d : d) - this.padding,
                    g = f.maxHeight,
                    m, v = this.clipRect,
                    h = f.navigation,
                    l = n(h.animation, !0),
                ...
                a > d && !1 !== h.enabled ? (this.clipHeight = m = Math.max(d - 20 - this.titleHeight - M, 0), this.currentPage = n(this.currentPage, 1), this.fullHeight =
                    a, k(z, function(a, b) {
                        ...
                        d !== u && (u = d)
                    }), v || (v = e.clipRect = c.clipRect(0, M, 9999, 0), e.contentGroup.clip(v)), q(m), x || (this.nav = x = c.g().attr({
                            zIndex: 1
                        ...
                        this.down = c.symbol("triangle-down", 0, 0, G, G).on("click", function() {
                            e.scroll(1, l)
                        }).add(x)), e.scroll(0), a = d) : x && (q(b.chartHeight), x.hide(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0);
                return a
            },
            scroll: function(a, e) {
                ...
                0 < a && (void 0 !== e && c(e, this.chart), this.nav.attr({
                        ...
                        fill: a === f ? d.inactiveColor : d.activeColor
                    }).css({
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function(a, e) {
                var b = a.options,
                    ...
                    b = b.squareSymbol;
                e.legendSymbol = this.chart.renderer.rect(b ? (a.symbolWidth - c) / 2 : 0, a.baseline - c + 1, b ? c : a.symbolWidth, c, n(a.options.symbolRadius, c / 2)).addClass("highcharts-point").attr({
                    zIndex: 3
                }).add(e.legendGroup)
            },
        ...
        B.prototype = {
            ...
            redraw: function(b) {
                ...
                for (this.layOutTitles(); t--;)
                    if (b = e[t], b.options.stacking && (p = !0, b.isDirty)) {
                        D = !0;
                        break
                    }
                if (D)
                    for (t = v; t--;) b = e[t], b.options.stacking && (b.isDirty = !0);
                g(e, function(a) {
            ...
            get: function(a) {
                ...
                for (e = 0; e < d.length; e++)
                    if (d[e].options.id === a) return d[e];
                for (e = 0; e < d.length; e++)
                    for (c = d[e].points || [], b = 0; b < c.length; b++)
            ...
            getSelectedPoints: function() {
                ...
                g(this.series, function(d) {
                    a = a.concat(b(d.points || [], function(a) {
                        return a.selected
                    }))
                });
                return a
            ...
            layOutTitles: function(a) {
                ...
                g(["title", "subtitle"], function(a) {
                    var d = this[a],
                        f = this.options[a],
                        g;
                    d && (g = f.style.fontSize, g = e.fontMetrics(g, d).b, d.css({
                        width: (f.width || c.width + f.widthAdjust) + "px"
                    }).align(z({
                        y: b + g + ("title" === a ? -3 : 2)
                    }, f), !1, "spacingBox"), f.floating || f.verticalAlign || (b = Math.ceil(b + d.getBBox().height)))
                }, this);
            ...
            renderLabels: function() {
                ...
                b.items && g(b.items, function(d) {
                    var c = z(b.style, d.style),
                        e = G(c.left) + a.plotLeft,
                        f = G(c.top) + a.plotTop + 12;
                    delete c.left;
                    delete c.top;
    ...
    (function(a) {
        ...
        C.prototype = {
            ...
            applyOptions: function(a, c) {
                ...
                m && (this.y = this[m]);
                this.isNull = q(this.isValid &&
                    !this.isValid(), null === this.x || !r(this.y, !0));
            ...
            optionsToObject: function(a) {
                var c = {},
                    ...
                    e = 0,
                    b = 0;
                if (r(a) || null === a) c[h[0]] = a;
                else if (l(a))
                    for (!m && a.length > f && (g = typeof a[0], "string" === g ? c.name = a[0] : "number" === g && (c.x = a[0]), e++); b < f;) m && void 0 ===
                        a[e] || (c[h[b]] = a[e]), e++, b++;
                else "object" === typeof a && (c = a, a.dataLabels && (g._hasPointLabels = !0), a.marker && (g._hasPointMarkers = !0));
                return c
            },
            ...
            destroyElements: function() {
                for (var a = ["graphic", "dataLabel", "dataLabelUpper",
                    ...
                    ], c, g = 6; g--;) c = a[g], this[c] && (this[c] = this[c].destroy())
            },
    ...
    (function(a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            getCyclic: function(a, b, d) {
                var c, e = this.userOptions,
                    f = a + "Index",
                    g = a + "Counter",
                    x = d ? d.length : K(this.chart.options.chart[a + "Count"], this.chart[a +
                        "Count"]);
            ...
            setData: function(a, d, g, p) {
                ...
                if (!1 !== p && t && v === t && !x.cropped && !x.hasGroupedData && x.visible) h(a, function(a, b) {
                    ...
                    if (l && t > l) {
                        ...
                        if (e(G))
                            for (g = 0; g < t; g++) k[g] = this.autoIncrement(), z[g] = a[g];
                        else if (f(G))
                            if (F)
                                for (g =
                                    0; g < t; g++) G = a[g], k[g] = G[0], z[g] = G.slice(1, F + 1);
                            else
                                for (g = 0; g < t; g++) G = a[g], k[g] = G[0], z[g] = G[1];
                        else c(12)
                    } else
                        for (g = 0; g < t; g++) void 0 !== a[g] && (G = {
                            series: x
                        }, x.pointClass.prototype.applyOptions.apply(G, [a[g]]), x.updateParallelArrays(G, g));
                    b(z[0]) && c(14, !0);
                    x.data = [];
            ...
            processData: function(a) {
                var b = this.xData,
                    ...
                    f;
                f = 0;
                var g, p, m = this.xAxis,
                    h, v = this.options;
                h = v.cropThreshold;
                var t = this.getExtremesFromAll || v.getExtremesFromAll,
                    y = this.isCartesian,
                    v = m && m.val2lin,
                    G = m && m.isLog,
                    n, l;
                ...
                if (y && this.sorted && !t && (!h || e > h || this.forceCrop))
                    if (b[e - 1] < n || b[0] > l) b = [], d = [];
                    else if (b[0] < n || b[e - 1] > l) f = this.cropData(this.xData, this.yData, n, l), b = f.xData, d = f.yData,
                    f = f.start, g = !0;
            ...
            generatePoints: function() {
                ...
                if (b && (g !== (d = b.length) || h))
                    for (y = 0; y < d; y++) y !== p || h || (y += g), b[y] && (b[y].destroyElements(), b[y].plotX = void 0);
                this.data = b;
                this.points =
                    t
            },
            getExtremes: function(a) {
                ...
                c = a.length;
                for (n = 0; n < c; n++)
                    if (t = d[n], y = a[n], v = (e(y, !0) || f(y)) && (!b.isLog || y.length || 0 < y), t = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (d[n + 1] || t) >= m && (d[n - 1] || t) <= h, v && t)
                        if (v = y.length)
                            for (; v--;) null !== y[v] && (g[p++] = y[v]);
                        else g[p++] = y;
                this.dataMin = H(g);
                this.dataMax = E(g)
            },
            translate: function() {
                ...
                for (var a = this.options, b = a.stacking, d = this.xAxis, c = d.categories, f = this.yAxis, g = this.points, p = g.length, m = !!this.modifyValue, h = a.pointPlacement, v = "between" === h || e(h), t = a.threshold, y = a.startFromThreshold ? t : 0, n, l, k, z, F = Number.MAX_VALUE, a = 0; a < p; a++) {
                    var I = g[a],
                        ...
                        A = I.y;
                    l = I.low;
                    var C = b && f.stacks[(this.negStacks && A < (y ? 0 : t) ? "-" : "") + this.stackKey],
                        E;
            ...
            setClip: function(a) {
                var b = this.chart,
                    ...
                    f = this.clipBox,
                    g = f || b.clipBox,
                    p = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, g.height, d.xAxis, d.yAxis].join(),
                    m = b[p],
                    h = b[p + "m"];
                m || (a && (g.width = 0, b[p + "m"] = h = c.clipRect(-99, e ? -b.plotLeft : -b.plotTop, 99, e ? b.chartWidth : b.chartHeight)), b[p] = m = c.clipRect(g), m.count = {
                    length: 0
                });
            ...
            drawPoints: function() {
                var a = this.points,
                    b = this.chart,
                    d, c, f, g, p = this.options.marker,
                    m, h, v, t, y = this.markerGroup,
                    n = K(p.enabled, this.xAxis.isRadial ? !0 : null,
            ...
            drawGraph: function() {
                ...
                h(c, function(c, e) {
                    ...
                    g ? (g.endX = d.xMap, g.animate({
                        d: d
                    })) : d.length && (a[f] = a.chart.renderer.path(d).addClass(c[1]).attr({
                        zIndex: 1
                    }).add(a.group), g = {
                        stroke: c[2],
            ...
            render: function() {
                var a =
                    ...
                    b = a.chart,
                    d, c = a.options,
                    e = !!a.animate && b.renderer.isSVG && A(c.animation).duration,
    ...
    (function(a) {
        ...
        C.prototype = {
            ...
            render: function(a) {
                var h = this.options,
                    c = h.format,
                    c = c ? r(c, this) : h.formatter.call(this);
        ...
        A.prototype.buildStacks = function() {
            var a = this.series,
                n, c = q(this.options.reversedStacks, !0),
                g = a.length,
                m;
            if (!this.isXAxis) {
                ...
                if (this.usePercentage)
                    for (m = 0; m < g; m++) a[m].setPercentStacks()
            }
        };
        A.prototype.renderStackTotals = function() {
            var a = this.chart,
                n = a.renderer,
                c = this.stacks,
                g, m, l = this.stackTotalGroup;
            l || (this.stackTotalGroup = l = n.g("stack-labels").attr({
                visibility: "visible",
                zIndex: 6
            }).add());
            l.translate(a.plotLeft, a.plotTop);
            for (g in c)
                for (m in a = c[g], a) a[m].render(l)
        };
        A.prototype.resetStacks = function() {
            ...
            if (!this.isXAxis)
                for (l in a)
                    for (c in a[l]) a[l][c].touched < this.stacksTouched ? (a[l][c].destroy(),
                        delete a[l][c]) : (a[l][c].total = null, a[l][c].cum = 0)
        };
        A.prototype.cleanStacks = function() {
            var a, l, c;
            if (!this.isXAxis)
                for (l in this.oldStacks && (a = this.stacks = this.oldStacks), a)
                    for (c in a[l]) a[l][c].cum = a[l][c].total
        };
        ...
        a.prototype.setPercentStacks = function() {
            var a = this,
                ...
                m;
            l([n, "-" + n], function(h) {
                for (var f = g.length, e, b; f--;)
                    if (e = g[f], m = a.getStackIndicator(m,
        ...
        q(e.prototype, {
            ...
            update: function(a, c) {
                var d = this,
                    ...
                    f = this.userOptions,
                    g = this.type,
                    p = a.type || f.type || e.options.chart.type,
                    h = b[g].prototype,
        ...
        k("area", "line", {
            ...
            getStackPoints: function() {
                var a = [],
                    ...
                    q = this.xAxis,
                    h = this.yAxis,
                    n = h.stacks[this.stackKey],
                    c = {},
                    g = this.points,
                    m = this.index,
                    z = h.series,
                    f = z.length,
                    e, b = H(h.options.reversedStacks, !0) ? 1 : -1,
                    p, w;
                    ...
                    A(k, function(d, g) {
                        ...
                        if (c[d] && !c[d].isNull) a.push(c[d]), A([-1, 1], function(a) {
                            var h = 1 === a ? "rightNull" : "leftNull",
                                ...
                                y = n[k[g + a]];
                            if (y)
                                for (p = m; 0 <= p && p < f;) v = y.points[p], v || (p === m ? c[d][h] = !0 : e[p] && (l = n[d].points[p]) && (t -= l[1] - l[0])), p += b;
            ...
            getGraphPath: function(a) {
                var l = w.prototype.getGraphPath,
                    k = this.options,
                    h = k.stacking,
                    n = this.yAxis,
                    c, g, m = [],
                    z = [],
                    f = this.index,
                    e, b = n.stacks[this.stackKey],
                    p = k.threshold,
                    K = n.getThreshold(k.threshold),
                    d, k = k.connectNulls || "percent" === h,
                    F = function(d, c, g) {
                        var v = a[d];
                        d = h && b[v.x].points[f];
                        var t = v[g + "Null"] || 0;
                ...
                for (c = 0; c < a.length; c++)
                    if (g = a[c].isNull, e = H(a[c].rectPlotX, a[c].plotX), d = H(a[c].yBottom, K), !g || k) k || F(c, c - 1, "left"), g && !h && k || (z.push(a[c]), m.push({
                        x: c,
                        plotX: e,
                        plotY: d
                    })), k || F(c, c + 1, "right");
            ...
            drawGraph: function() {
                ...
                A(h, function(h) {
                    var c = h[0],
                        g = a[c];
                    g ? (g.endX = k.xMap, g.animate({
                        d: k
                    })) : (g = a[c] = a.chart.renderer.path(k).addClass(h[1]).attr({
                        fill: H(h[3],
                            C(h[2]).setOpacity(H(q.fillOpacity, .75)).get()),
                        zIndex: 0
    ...
    (function(a) {
        ...
        q("column", "line", {
            ...
            getColumnMetrics: function() {
                ...
                var k = Math.min(Math.abs(m.transA) * (m.ordinalSlope || g.pointRange || m.closestPointRange || m.tickInterval || 1), m.len),
                    d = k * g.groupPadding,
                    n = (k - 2 * d) / p,
                    g = Math.min(g.maxPointWidth || m.len, l(g.pointWidth, n * (1 - 2 * g.pointPadding)));
                a.columnMetrics = {
                    width: g,
            ...
            translate: function() {
                var a = this,
                    ...
                    h = a.borderWidth =
                    l(m.borderWidth, h ? 0 : 1),
                    f = a.yAxis,
                    e = a.translatedThreshold = f.getThreshold(m.threshold),
                    b = l(m.minPointLength, 5),
                    p = a.getColumnMetrics(),
                    k = p.width,
                    d = a.barW = Math.max(k, 1 + 2 * h),
                    n = a.pointXOffset = p.offset;
                g.inverted && (e -= .5);
                ...
                E(a.points, function(c) {
                    var p = l(c.yBottom, e),
                        m = 999 + Math.abs(p),
                        m = Math.min(Math.max(-m, c.plotY), f.len + m),
                        h = c.plotX + n,
                        t = d,
                        x = Math.min(m, p),
                        D, z = Math.max(m, p) - x;
            ...
            pointAttribs: function(a, g) {
                var c = this.options,
                    ...
                    f = h.stroke ||
                    "borderColor",
                    e = h["stroke-width"] || "borderWidth",
                    b = a && a.color || this.color,
                    p = a[f] || c[f] || this.color || b,
                    h = c.dashStyle,
                    l;
            ...
            drawPoints: function() {
                ...
                E(a.points, function(b) {
                    var c = b.graphic;
                    w(b.plotY) && null !== b.y ? (e = b.shapeArgs, c ? (h(c), c[g.pointCount < f ? "animate" : "attr"](k(e))) : b.graphic = c = l[b.shapeType](e).attr({
                        "class": b.getClassName()
                    }).add(b.group || a.group), c.attr(a.pointAttribs(b, b.selected && "select")).shadow(m.shadow, null, m.stacking && !m.borderRadius)) : c && (b.graphic = c.destroy())
                })
            },
            animate: function(a) {
                var c = this,
        ...
        h("pie", "line", {
            ...
            translate: function(a) {
                ...
                var c = 0,
                    ...
                    k = h.slicedOffset,
                    f = k + (h.borderWidth || 0),
                    e, b, p, n = h.startAngle || 0,
                    d = this.startAngleRad = Math.PI / 180 * (n - 90),
                    n = (this.endAngleRad = Math.PI / 180 * (l(h.endAngle, n + 360) - 90)) - d,
                    q = this.points,
                    t = h.dataLabels.distance,
                ...
                for (v = 0; v < y; v++) {
                    ...
                    r.slicedTranslation = {
                        translateX: Math.round(Math.cos(p) * k),
                        translateY: Math.round(Math.sin(p) *
                            k)
                    };
                    e = Math.cos(p) * a[2] / 2;
                    b = Math.sin(p) * a[2] / 2;
            ...
            drawPoints: function() {
                ...
                E(a.points, function(c) {
                    if (null !== c.y) {
                        ...
                        l ? l.setRadialReference(a.center).attr(f).animate(H(e, h)) : (c.graphic = l = g[c.shapeType](e).addClass(c.getClassName()).setRadialReference(a.center).attr(h).add(a.group), c.visible || l.attr({
                            visibility: "hidden"
                        }), l.attr(f).attr({
                            "stroke-linejoin": "round"
                        }).shadow(b, p))
    ...
    (function(a) {
        ...
        c.prototype.drawDataLabels = function() {
            var a = this,
                ...
                b = c.dataLabels,
                g = a.points,
                m, d, l = a.hasRendered || 0,
                t, v, y = h(b.defer, !0),
                n = a.chart.renderer;
            if (b.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(b), v = a.plotGroup("dataLabelsGroup", "data-labels", y && !l ? "hidden" : "visible", b.zIndex || 6), y && (v.attr({
                    opacity: +l
                }),
                l || C(a, "afterAnimate", function() {
                    a.visible && v.show(!0);
                    v[c.animation ? "animate" : "attr"]({
                        opacity: 1
                    }, {
                        duration: 200
                    })
                ...
                if (g && !f) e.dataLabel = g.destroy();
                    ...
                    if (g) E(t) ? (g.attr({
                        ...
                        g = g.destroy(), y && (e.connector = y.destroy()));
                    else if (E(t)) {
                        g = {
        ...
        c.prototype.alignDataLabel = function(a, c, b, g, m) {
            var d = this.chart,
                ...
                n, k = b.rotation,
                x = b.align,
                D = this.visible && (a.series.forceDL || d.isInsidePlot(f, Math.round(p), e) || g && d.isInsidePlot(f, e ? g.x + 1 : g.y + g.height - 1, e)),
                q = "justify" === h(b.overflow, "justify");
            D && (n = b.style.fontSize, n = d.renderer.fontMetrics(n, c).b, g = w({
                x: e ? d.plotWidth -
                    p : f,
                y: Math.round(e ? d.plotHeight - f : p),
                width: 0,
                height: 0
            }, g), w(b, {
                width: l.width,
                ...
                y: g.y + b.y + {
                    ...
                    middle: .5,
                    bottom: 1
                }[b.verticalAlign] * g.height
            }, c[m ? "attr" : "animate"](e).attr({
                align: x
            }), f = (k + 720) % 360, f = 180 < f && 360 > f, "left" === x ? e.y -= f ? l.height : 0 : "center" === x ? (e.x -= l.width / 2, e.y -= l.height / 2) : "right" === x && (e.x -= l.width, e.y -= f ? 0 : l.height)) : (c.align(b, null, g), e = c.alignAttr), q ? this.justifyDataLabel(c, b, e, l, g, m) : h(b.crop, !0) && (D = d.isInsidePlot(e.x,
        ...
        g.pie && (g.pie.prototype.drawDataLabels = function() {
            var f = this,
                e = f.data,
                b, g = f.chart,
                m = f.options.dataLabels,
                d = h(m.connectorPadding, 10),
                n = h(m.connectorWidth, 1),
                t = g.plotWidth,
                v = g.plotHeight,
                k, q = m.distance,
                r = f.center,
            ...
            f.visible && (m.enabled || f._hasPointLabels) && (c.prototype.drawDataLabels.apply(f), H(e, function(a) {
                ...
                var h, p, k = e.length,
                    n, y, B;
                if (k)
                    for (f.sortByAngle(e, c - .5), 0 < q && (h = Math.max(0, D - x - q), p = Math.min(D + x + q, g.plotHeight), n = l(e, function(a) {
            ...
            return h(this.options.softConnector, !0) ? ["M", e + ("left" === a[6] ? 5 : -5), b, "C", e, b, 2 * a[2] - a[4], 2 * a[3] - a[5], a[2], a[3], "L", a[4],
                a[5]
            ] : ["M", e + ("left" === a[6] ? 5 : -5), b, "L", a[2], a[3], "L", a[4], a[5]]
        }, g.pie.prototype.placeDataLabels = function() {
            H(this.points, function(a) {
                var e = a.dataLabel;
                e && a.visible && ((a = e._pos) ? (e.attr(e._attr), e[e.moved ? "animate" : "attr"](a), e.moved = !0) : e && e.attr({
                    y: -9999
                }))
            })
        ...
        g.column && (g.column.prototype.alignDataLabel = function(a, e, b, g, m) {
            var d = this.chart.inverted,
                ...
                n = h(b.inside, !!this.options.stacking);
            p && (g = r(p), 0 >
    ...
    (function(a) {
        ...
        C.prototype.hideOverlappingLabels = function(a) {
            var k = a.length,
                l, r, q, h, n, c, g, m, z, f = function(a, b, c, f, d, g, h, m) {
                    return !(d > a + c || d + h < a || g > b + f || g + m < b)
                };
            for (r = 0; r < k; r++)
                if (l = a[r]) l.oldOpacity =
                    l.opacity, l.newOpacity = 1;
            a.sort(function(a, b) {
                return (b.labelrank || 0) - (a.labelrank || 0)
            });
            for (r = 0; r < k; r++)
                for (q = a[r], l = r + 1; l < k; ++l)
                    if (h = a[l], q && h && q.placed && h.placed && 0 !== q.newOpacity && 0 !== h.newOpacity && (n = q.alignAttr, c = h.alignAttr, g = q.parentGroup, m = h.parentGroup, z = 2 * (q.box ? 0 : q.padding), n = f(n.x + g.translateX, n.y + g.translateY, q.width - z, q.height - z, c.x + m.translateX, c.y + m.translateY, h.width - z, h.height - z)))(q.labelrank < h.labelrank ? q : h).newOpacity = 0;
            A(a, function(a) {
                var b, c;
    ...
    (function(a) {
        ...
        K = a.TrackerMixin = {
            ...
            drawTrackerGraph: function() {
                ...
                if (f && !c)
                    for (u = f + 1; u--;) "M" === e[u] && e.splice(u + 1, 0, e[u + 1] - n, e[u + 2], "L"), (u && "M" === e[u] || u === f) && e.splice(u, 0, "L", e[u - 2] + n, e[u - 1]);
                k ? k.attr({
                    d: e
                }) : a.graph && (a.tracker = x.path(e).attr({
                    "stroke-linejoin": "round",
            ...
            pan: function(a, b) {
                ...
                l("xy" === b ? [1, 0] : [1], function(b) {
                    ...
                    var c = b.horiz,
                        ...
                        p = b.toValue(g - f, !0) + h,
                        h =
                        b.toValue(g + b.len - f, !0) - h,
                        g = g > f;
                    b.series.length && (g || p > Math.min(m.dataMin, m.min)) && (!g || h < Math.max(m.dataMax, m.max)) && (b.setExtremes(p, h, !1, !1, {
                        trigger: "pan"
                    }), e = !0);
                    d[c] = f
                });
        ...
        r(f.prototype, {
            ...
            setState: function(b, c) {
                var d = Math.floor(this.plotX),
                    e = this.plotY,
                    f = this.series,
                    g = f.options.states[b] || {},
                    h = k[f.type].marker && f.options.marker,
                    m = h && !1 === h.enabled,
                    p = h && h.states && h.states[b] || {},
                    l = !1 === p.enabled,
                ...
                if (!(b === this.state && !c || this.selected && "select" !== b || !1 === g.enabled || b && (l || m && !1 === p.enabled) || b && q.states && q.states[b] && !1 === q.states[b].enabled)) {
                    ...
                    }(d = g.halo) && d.size ? (F || (f.halo = F = w.renderer.path().add(f.markerGroup || f.group)), a.stop(F), F[c ? "animate" : "attr"]({
        ...
        r(e.prototype, {
            ...
            setState: function(a) {
                ...
                if (b.state !== a && (l([b.group, b.markerGroup], function(d) {
                        ...
                        (f = e[a].lineWidth || f + (e[a].lineWidthPlus || 0)), c && !c.dashstyle))
                    for (e = {
                            "stroke-width": f
                        }, c.attr(e); b["zone-graph-" + d];) b["zone-graph-" + d].attr(e), d += 1
            },
            setVisible: function(a, b) {
                var d = this,
                    c = d.chart,
                    e = d.legendItem,
                    f, g = c.options.chart.ignoreHiddenSeries,
                    h = d.visible;
            ...
            function l(a, n, c) {
                ...
                for (g in a)
                    if (-1 < E(g, ["series", "xAxis", "yAxis"]))
                        for (a[g] = k(a[g]), c[g] = [], h = 0; h < a[g].length; h++) c[g][h] = {}, l(a[g][h], n[g][h], c[g][h]);
                    else H(a[g]) ? (c[g] = {}, l(a[g], n[g] || {}, c[g])) : c[g] = n[g] || null
            }
            var q = {};
            l(a, this.options, q);
            return q
        ...
        r(A.prototype, {
            beforeSetTickPositions: function() {
                var a, g = [],
                    ...
                    e = f.min,
                    b = f.max,
                    p, k = this.isXAxis && !!this.options.breaks,
            ...
            lin2val: function(a, g) {
                ...
                if (c) {
                    var h = this.ordinalSlope,
                        ...
                        e = c.length - 1,
                        b;
                    if (g) 0 > a ? a = c[0] : a > e ? a = c[e] : (e = Math.floor(a), b = a - e);
                    else
                        for (; e--;)
                            if (g =
                                h * e + f, a >= g) {
        ...
        a(E.prototype, "pan", function(a, g) {
            ...
            if (c.options.ordinal && c.series.length) {
                var e = this.mouseDownX,
                    ...
                    d = b.max,
                    k = this.hoverPoints,
                    t = c.closestPointRange,
                    e = (e - h) / (c.translationSlope * (c.ordinalSlope || t)),
                    v = {
                ...
                v.ordinalPositions ? 1 < Math.abs(e) && (k && l(k, function(a) {
                    a.setState()
                }), 0 > e ? (k = v, q = c.ordinalPositions ? c : v) : (k = c.ordinalPositions ? c : v, q = v), v = q.ordinalPositions, p > v[v.length - 1] && v.push(p), this.fixedRange = d - n, e = c.toFixedRange(null, null, t.apply(k, [y.apply(k, [n, !0]) + e, !0]), t.apply(q, [y.apply(q, [d, !0]) + e, !0])), e.min >= Math.min(b.dataMin, n) && e.max <= Math.max(p, d) && c.setExtremes(e.min, e.max, !0, !1, {
                    trigger: "pan"
    ...
    (function(a) {
        ...
        H(r.prototype, "init", function(a, n, c) {
            ...
            if (this.options.breaks) {
                ...
                this.val2lin = function(a) {
                    var c = a,
                        f, e;
                    for (e = 0; e < g.breakArray.length; e++)
                        if (f = g.breakArray[e], f.to <= a) c -= f.len;
                        else if (f.from >= a) break;
                    else if (g.isInBreak(f, a)) {
                        c -= a - f.from;
                        break
                    }
                    return c
        ...
        H(q.prototype, "generatePoints", function(a) {
            ...
            var h = this.xAxis,
                ...
                e;
            if (h && c && (h.options.breaks || c.options.breaks))
                for (; k--;) l = g[k], e = null === l.y && !1 === f, e || !h.isInAnyBreak(l.x, !0) && !c.isInAnyBreak(l.y, !0) || (g.splice(k, 1), this.data[k] && this.data[k].destroyElements())
        });
            ...
            function(a, n) {
                ...
                w(n, function(b) {
                    ...
                    w(g, function(c) {
                        ...
                        w(h, function(b) {
                            f = !1;
                            if (k < b.from && e > b.to || k > b.from && e < b.from) f = "pointBreak";
                            else if (k < b.from && e > b.from && e < b.to || k > b.from && e > b.to && e < b.from) f = "pointInBreak";
                            f && l(a, f, {
                                point: c,
                                brk: b
                            })
    ...
    (function(a) {
        ...
        f.groupData = function(a, b, d, c) {
            ...
            for (w; w <= m; w++) {
                for (;
                    (void 0 !== d[z + 1] && a[w] >= d[z + 1] || w === m) && (n = d[z], this.dataGroupInfo = {
                        start: k,
                        length: q[0].length
        ...
        f.processData = function() {
            var a = this.chart,
                ...
                d = !1 !== this.allowDG && b && c(b.enabled, a.options._stock),
            ...
            if (!1 !== e.apply(this, arguments) && d && g) {
                ...
                var p = this.processedXData,
                    ...
                    a = this.xAxis,
                    n = a.options.ordinal,
                    k = this.groupPixelWidth = a.getGroupPixelWidth &&
        ...
        E.prototype.setDataGrouping = function(a, b) {
            ...
            else k(this.chart.options.series, function(b) {
                b.dataGrouping = a
            }, !1);
            b && this.chart.redraw()
        }
            ...
            drawPoints: function() {
                ...
                C(a.points, function(l) {
                    ...
                    void 0 !== l.plotY && (c || (l.graphic = c = k.renderer.path().add(a.group)), c.attr(a.pointAttribs(l, l.selected && "select")), q = c.strokeWidth() % 2 / 2, g = Math.round(l.plotX) - q, h = Math.round(l.shapeArgs.width / 2), n = ["M", g, Math.round(l.yBottom), "L", g, Math.round(l.plotY)], null !== l.open && (r = Math.round(l.plotOpen) +
                        q, n.push("M", g, r, "L", g - h, r)), null !== l.close && (r = Math.round(l.plotClose) + q, n.push("M", g, r, "L", g + h, r)), c[m ? "attr" : "animate"]({
                        d: n
    ...
    (function(a) {
        ...
        H("candlestick", "ohlc", E(C.column, {
            ...
            pointAttribs: function(a, l) {
                var k = w.column.prototype.pointAttribs.call(this, a, l),
                    q = this.options,
                    h = a.open < a.close,
                    n = q.lineColor || this.color;
        ...
        k("flags", "column", {
            ...
            translate: function() {
                ...
                var a = a.onKey || "y",
                    ...
                    t, v, y;
                if (k && k.visible && p)
                    for (r = (k.pointXOffset || 0) + (k.barW || 0) / 2, k = k.currentDataGrouping, v = b[p - 1].x + (k ? k.totalRange : 0), g.sort(function(a, b) {
                            return a.x - b.x
            ...
            drawTracker: function() {
                ...
                A(a, function(c) {
                    ...
                    g && C(g.element, "mouseover", function() {
                        0 < c.stackIndex && !c.raised && (c._y = g.y, g.attr({
                            y: c._y - 8
                        }), c.raised = !0);
                        A(a, function(a) {
    ...
    (function(a) {
        ...
        C.prototype = {
            ...
            setRange: function(a, c) {
                var b = this.options,
                    ...
                    e = b.minWidth,
                    f = this.barWidth,
                    g, h, l = this.rendered && !this.hasDragged ? "animate" : "attr";
                k(f) && (a = Math.max(a, 0), g = f * a, this.calculatedWidth = h = H(f * Math.min(c, 1) - g), h < e && (g = (f - e + h) * a, h = e), e = Math.floor(g + this.xOffset + this.yOffset), f = h / 2 - .5, this.from = a, this.to = c, d ? (this.scrollbarGroup[l]({
                        translateY: e
                    }), this.scrollbar[l]({
                        height: h
                    }),
                    ...
                    translateX: f
                }), this.scrollbarLeft = e, this.scrollbarTop = 0), 12 >= h ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0), !1 === b.showFull && (0 >= a && 1 <= c ? this.group.hide() : this.group.show()), this.rendered = !0)
            },
            initEvents: function() {
                var a = this;
        ...
        f(E.prototype, "render", function(a) {
            var b = Math.min(m(this.options.min, this.min), this.min, this.dataMin),
                c = Math.max(m(this.options.max, this.max), this.max, this.dataMax),
                d = this.scrollbar,
                e;
    ...
    (function(a) {
        ...
        C.prototype = {
            ...
            render: function(a, b, c, d) {
                ...
                if (f(a) && f(b) && (!this.hasDragged || l(c)) && (this.navigatorLeft = h = K(p.left, e.plotLeft + n), this.navigatorWidth =
                    ...
                    !w && v && (this.navigatorGroup = c = g.g("navigator").attr({
                            zIndex: 3
                        }).add(),
                        this.leftShade = g.rect().addClass("highcharts-navigator-mask" + (x ? "-inside" : "")).attr({
                            fill: u.maskFill
                        }).css(x && {
                            cursor: "ew-resize"
                        }).add(c), x || (this.rightShade = g.rect().addClass("highcharts-navigator-mask").attr({
                            fill: u.maskFill
                        }).add(c)), this.outline = g.path().addClass("highcharts-navigator-outline").attr({
                    ...
                    if (v) {
                        ...
                        if (this.rightShade) this.rightShade[g]({
                            x: h + b,
                            y: q,
                            width: k - b,
                            height: t
                        ...
                        this.outline[g]({
                            d: ["M", m, w, "L", h + a - x, w, h + a - x, w + r, "L", h + b - x, w + r, "L", h + b - x, w, m + n, w].concat(u.maskInside ? ["M", h + a + x, w, "L", h + b - x, w] : [])
                        });
            ...
            init: function(a) {
                ...
                k.mouseDownHandler = function(c) {
                    ...
                    v > f && v < f + g && (Math.abs(q - d - p) < w ? (k.grabbedLeft = !0, k.otherHandlePos = e, k.fixedExtreme = c.max, a.fixedRange = null) : Math.abs(q - e - p) < w ? (k.grabbedRight = !0, k.otherHandlePos = d, k.fixedExtreme = c.min, a.fixedRange = null) : q > p + d - x && q < p + e + x ? (k.grabbedCenter = q, k.fixedWidth = t, n = q - d) : q > h && q < h + l && (e = q - p - t / 2, 0 > e ? e = 0 : e + t >= u && (e = u - t, r = k.getUnionExtremes().dataMax), e !== d && (k.fixedWidth = t, d = m.toFixedRange(e,
                        e + t, null, r), c.setExtremes(d.min, d.max, !0, null, {
                        trigger: "navigator"
                    }))))
                };
                ...
                k.mouseUpHandler = function(b) {
                    ...
                    if (k.hasDragged || "scrollbar" === b.trigger) k.zoomedMin === k.otherHandlePos ? c = k.fixedExtreme : k.zoomedMax === k.otherHandlePos && (d = k.fixedExtreme), k.zoomedMax === k.navigatorWidth && (d = k.getUnionExtremes().dataMax), c = m.toFixedRange(k.zoomedMin, k.zoomedMax, c, d), l(c.min) && a.xAxis[0].setExtremes(c.min, c.max, !0, k.hasDragged ? !1 : null, {
                        trigger: "navigator",
                ...
                var c = a.xAxis.length,
                    f = a.yAxis.length,
                    x = e && e[0] && e[0].xAxis || a.xAxis[0];
                ...
                a.options.scrollbar.enabled && (a.scrollbar = k.scrollbar = new F(a.renderer, p(a.options.scrollbar, {
                    margin: k.navigatorEnabled ? 0 : 10
                }), a), A(k.scrollbar, "changed", function(b) {
            ...
            addBaseSeriesEvents: function() {
                ...
                !1 !== this.navigatorOptions.adaptToUpdatedData && h(b, function(b) {
                    b.xAxis && (A(b, "updatedData",
                        this.updatedDataHandler), b.userOptions.events = g(b.userOptions.event, {
        ...
        y(H.prototype, "getMargins", function(a) {
            ...
            d && (e = d.xAxis, f = d.yAxis, d.top = d.navigatorOptions.top || this.chartHeight - d.height - d.scrollbarHeight - this.spacing[2] - ("bottom" === c.verticalAlign && c.enabled &&
                !c.floating ? b.legendHeight + K(c.margin, 10) : 0), e && f && (e.options.top = f.options.top = d.top, e.setAxisSize(), f.setAxisSize()))
        });
        ...
        C.prototype = {
            clickButton: function(a, e) {
                var g = this,
                    ...
                    m = g.buttonOptions[a],
                    n = k.xAxis[0],
                    p = k.scroller && k.scroller.getUnionExtremes() || n || {},
                    q = p.dataMin,
                    t = p.dataMax,
                    v, r = n && Math.round(Math.min(n.max, b(t, n.max))),
                    w = m.type,
                    C, p = m._range,
                    F, H, K, N = m.dataGrouping;
                if (null !== q && null !== t && a !== g.selected) {
                    ...
                    if ("month" === w || "year" === w) n ? (w = {
                        ...
                        dataMin: q,
                        dataMax: t
                    }, v = n.minFromRange.call(w), f(w.newMax) && (r = w.newMax)) : p = m;
                    else if (p) v = Math.max(r - p, q), r = Math.min(v + p, t);
                    else if ("ytd" === w)
                        if (n) void 0 === t && (q = Number.MAX_VALUE, t = Number.MIN_VALUE, c(k.series, function(a) {
                            a = a.xData;
                            q = Math.min(a[0], q);
                            t = Math.max(a[a.length - 1], t)
                        }), e = !1), r = new z(t), v = r[z.hcGetFullYear](), v = F = Math.max(q || 0, z.UTC(v, 0, 1)), r = r.getTime(), r = Math.min(t || r, r);
                        else {
            ...
            updateButtonStates: function(a) {
                var b = this,
                    d = this.chart,
                    e = d.xAxis[0],
                    f = d.scroller && d.scroller.getUnionExtremes() || e,
                    g = f.dataMin,
                    h = f.dataMax,
                    k = b.selected,
                ...
                c(b.buttonOptions, function(a, c) {
                    ...
                    var v = d.renderer.forExport && c === k,
                        n = n === f,
                        r = !e.hasVisibleSeries;
            ...
            drawInput: function(a) {
                function b() {
                    ...
                    b !== t.previousValue && (t.previousValue = b, f(b) || (b = a.split("-"), b = Date.UTC(p(b[0]), p(b[1]) -
                        1, p(b[2]))), f(b) && (r.global.useUTC || (b += 6E4 * (new Date).getTimezoneOffset()), q ? b > c.maxInput.HCTime ? b = void 0 : b < h && (b = h) : b < c.minInput.HCTime ? b = void 0 : b > g && (b = g), void 0 !== b && e.setExtremes(q ? b : e.min, q ? e.max : b, void 0, void 0, {
                ...
                var c = this,
                    ...
                    n = c.div,
                    q = "min" === a,
                    t, z, A = this.inputGroup;
                this[a + "Label"] = z = l.label(r.lang[q ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).addClass("highcharts-range-label").attr({
                    padding: 2
                }).add(A);
                A.offset += z.width + 5;
            ...
            render: function(a, d) {
                ...
                !1 !== p.enabled && (N || (e.group = K = h.g("range-selector-buttons").add(), e.zoomText = h.text(m.rangeSelectorZoom, b(z.x, E), 15).css(p.labelStyle).add(K), F = b(z.x, E) + e.zoomText.getBBox().width +
                    5, c(e.buttonOptions, function(a, c) {
                        ...
                        height: 0,
                        zIndex: 1
                    }), l.parentNode.insertBefore(v, l), e.inputGroup = v = h.g("input-group").add(), v.offset = 0, e.drawInput("min"), e.drawInput("max"))), K[N ? "animate" : "attr"]({
                    translateY: H.buttonTop
                }), !1 !== A && (v.align(g({
                    y: H.inputTop,
                    width: v.offset,
    ...
    (function(a) {
        var C = a.arrayMax,
            ...
            y = v.init,
            I = v.processData,
            G = z.prototype.tooltipFormatter;
        a.StockChart = a.stockChart = function(a, b, d) {
            var e = n(a) || a.nodeName,
                f = arguments[e ? 1 : 0],
                h = f.series,
                k, l = m(f.navigator && f.navigator.enabled, !0) ? {
                    startOnTick: !1,
                    endOnTick: !1
                } : null,
                q = {
            ...
            k(l.isXAxis ? u.yAxis : u.xAxis, function(a) {
                if (w(a.options.id) ? -1 === a.options.id.indexOf("navigator") : 1) {
                    var b = a.isXAxis ? "yAxis" : "xAxis",
                        b = w(a.options[b]) ? u[b][a.options[b]] : u[b][0];
                    l === b && C.push(a)
                }
            });
        ...
        E.prototype.getPlotBandPath = function(a,
            ...
            if (a && b && a.toString() !== b.toString())
                for (d = 0; d < a.length; d += 6) c.push("M", a[d + 1], a[d + 2], "L", a[d + 4], a[d + 5], b[d + 4], b[d + 5], b[d + 1], b[d + 2]);
            else c = null;
            return c
        };
        ...
        v.processData = function() {
            ...
            if (this.xAxis && this.processedYData)
                for (c = this.processedXData, d = this.processedYData, e = d.length, this.pointArrayMap && (b = q("close", this.pointArrayMap), -1 === b && (b = q(this.pointValKey || "y", this.pointArrayMap))), a = 0; a < e - 1; a++)
                    if (f = -1 < b ? d[a][b] : d[a], h(f) && c[a + 1] >= this.xAxis.min && 0 !== f) {
                        this.compareValue =
                            f;
                        break
                    }
