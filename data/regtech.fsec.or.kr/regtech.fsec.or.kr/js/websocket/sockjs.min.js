            ...
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? ! function() {
                ...
                c.split = function(e, n) {
                    ...
                    for (e = new RegExp(e.source, f + "g"), r += "", t || (o = new RegExp("^" + e.source + "$(?!\\s)", f)), n = void 0 === n ? -1 >>> 0 : i(n);
                        (s = e.exec(r)) && (l = s.index + s[0].length, !(l > d && (c.push(r.slice(d, s.index)), !t && s.length > 1 && s[0].replace(o, function() {
                            ...
                            if ((p = b.hasOwnProperty) || (p = function(t) {
                                ...
                                e.stringify = function(t, e, n) {
                                    ...
                                    if (s[typeof e] && e)
                                        ...
                                        o = {};
                                        for (var l, u = 0, c = e.length; u < c; l = e[u++], a = y.call(l), (a == E || a == _) && (o[l] = 1));
                                    }
                                    if (n)
                                        if ((a = y.call(n)) == _) {
                                            if ((n -= n % 1) > 0)
