...
if __name__ == "__main__":
    ...
    try:
        if len(DASHBOARD_TEMPLATE) > 1000 and "<!DOCTYPE html>" in DASHBOARD_TEMPLATE:
            ...
            all_validation_failures.append(f"Dashboard template invalid: {len(DASHBOARD_TEMPLATE)} characters")
    ...
    try:
        ...
        if dashboard.app.route.called:
            ...
            all_validation_failures.append("Route setup function did not register routes")
    except Exception as e:
    ...
    try:
        ...
        if dashboard.socketio.on.called:
            ...
            all_validation_failures.append("SocketIO events setup did not register handlers")
    except Exception as e:
