...
def run_performance_analysis():
    ...
    try:
        ...
        try:
            ...
            logger.info(f"API Health Check: {response.status_code} - Response Time: {response_time:.2f}ms")
    ...
    try:
        ...
        with sqlite3.connect(db_path) as conn:
            ...
            try:
                ...
                # Source distribution
                cursor.execute("SELECT source, COUNT(*) FROM blacklist_entries GROUP BY source;")
