...
class InlineTestRunner:
    ...
    def print_summary(self):
        ...
        overall_success_rate = (total_passed_cases / total_test_cases * 100) if total_test_cases > 0 else 0
        ...
        print(f"🚀 가장 빠른 모듈: {fastest.module.split('.')[-1]} ({fastest.execution_time:.3f}초)")
        print(f"🐌 가장 느린 모듈: {slowest.module.split('.')[-1]} ({slowest.execution_time:.3f}초)")
