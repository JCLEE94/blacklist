        ...
        if validated_key:
            return jsonify({
                ...
                'key_info': {
                    ...
                    'expires_at': validated_key.expires_at.isoformat() if validated_key.expires_at else None,
    ...
    try:
        ...
        for key in all_keys:
            for perm in key.permissions:
                stats['permissions_breakdown'][perm] = stats['permissions_breakdown'].get(perm, 0) + 1
