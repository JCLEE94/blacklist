...
from ..utils.performance_optimizer import get_performance_monitor, optimize_database_queries
...
def get_performance_metrics():
    ...
    try:
        ...
        return jsonify({
            ...
            'recommendations': _generate_performance_recommendations(metrics, slow_queries)
        })
