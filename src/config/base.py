...
from src.core.constants import (
    DEFAULT_PORT, DEFAULT_DATA_DIR, DEFAULT_DB_URI, DEFAULT_REDIS_URL,
    DEFAULT_UPDATE_INTERVAL, DEFAULT_DATA_RETENTION_DAYS
)
...
class BaseConfig:
    ...
    ALERT_EMAIL_RECIPIENTS = [
        email.strip() for email in os.environ.get('ALERT_EMAIL_RECIPIENTS', '').split(',') 
        if email.strip()
    ]
