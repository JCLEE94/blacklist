...
class AdvancedAnalytics:
    ...
    def _calculate_severity_score(self, frequency: int, threat_level: str) -> float:
        ...
        return self._coordinator.threat_analyzer._calculate_severity_score(frequency, threat_level)
...
if __name__ == "__main__":
    ...
    if not network:
        ...
        all_validation_failures.append("Network Analysis: Invalid network_summary structure")
    else:
    ...
    if not correlations:
        ...
        all_validation_failures.append("Correlation Analysis: Invalid correlation_summary structure")
    else:
        corr_summary = correlations.get("correlation_summary", {})
        print(f"  - High correlation attacks: {corr_summary.get('high_correlation_attacks', 0)}")
    ...
    if not predictions:
        ...
        all_validation_failures.append("Predictive Insights: Invalid trend_predictions structure")
    else:
    ...
    if not report:
        ...
        all_validation_failures.append("Report Export: Invalid report_metadata structure")
    ...
    if not comprehensive:
        ...
        all_validation_failures.append("Comprehensive Analysis: Missing analysis sections")
