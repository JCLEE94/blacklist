...
if __name__ == "__main__":
    ...
    if not network:
        ...
        all_validation_failures.append("Network Analysis: Missing network_summary section")
    ...
    if not correlations:
        ...
        all_validation_failures.append("Correlation Analysis: Missing correlation_summary section")
    ...
    if not predictions:
        ...
        all_validation_failures.append("Predictive Analysis: Missing trend_predictions section")
    ...
    if not report:
        ...
        all_validation_failures.append("Report Generation: Missing report_metadata section")
