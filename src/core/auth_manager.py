...
class AuthManager:
    ...
    def _ensure_config_file(self):
        ...
        if not self.config_path.exists():
            default_config = {
                "regtech": {"username": "", "password": "", "enabled": False},
                "secudium": {"username": "", "password": "", "enabled": False},
            }
            ...
            with open(self.config_path, "r") as f:
                ...
                masked_config = {
                    ...
                    "secudium": {
                        ...
                        "password_set": bool(
                            config.get("secudium", {}).get("password")
                        ),
    ...
    def get_credentials(self, source: str) -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            if (
                source_config.get("enabled")
                and source_config.get("username")
                and source_config.get("password")
            ):
                return {
