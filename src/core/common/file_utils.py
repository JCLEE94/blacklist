...
class FileUtils:
    ...
    @staticmethod
    def read_ip_file(file_path: Union[str, Path], as_set: bool = True) -> Union[Set[str], List[str]]:
        """
    ...
    @staticmethod
    def write_ip_file(file_path: Union[str, Path], ips: Union[Set[str], List[str]], 
                      sorted_output: bool = True) -> bool:
        """
