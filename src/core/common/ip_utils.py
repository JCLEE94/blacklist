...
class IPUtils:
    ...
    @classmethod
    def extract_ips_from_text(cls, text: str, exclude_private: bool = True) -> List[str]:
        """
        텍스트에서 IP 주소 추출
    ...
    @classmethod
    def validate_ip_list(cls, ip_list: List[str], max_count: int = 100) -> Tuple[List[str], List[str]]:
        """
