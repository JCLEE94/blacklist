...
class DatabaseSchema:
    ...
    def __init__(self, database_url: str = None):
        ...
        if database_url:
            ...
            self.database_url = os.environ.get("DATABASE_URL", "sqlite:///instance/blacklist.db")
        ...
        self.migration_service = MigrationService(self.connection_manager, self.table_definitions)
    ...
    def get_instance(cls, db_path: str = None) -> 'DatabaseSchema':
        ...
        if not hasattr(cls, '_instance') or (db_path and cls._instance.db_path != db_path):
