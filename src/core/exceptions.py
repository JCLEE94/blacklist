...
class CacheError(BlacklistError):
    ...
    def __init__(self, message: str, cache_key: Optional[str] = None, 
                 operation: Optional[str] = None, cache_type: str = "unknown"):
        details = {
...
class DatabaseError(BlacklistError):
    ...
    def __init__(self, message: str, query: Optional[str] = None, 
                 table: Optional[str] = None, database_url: Optional[str] = None):
        details = {}
        if query:
            details['query'] = query
        if table:
...
class AuthenticationError(BlacklistError):
    ...
    def __init__(self, message: str, auth_type: Optional[str] = None, 
                 user_id: Optional[str] = None, required_permission: Optional[str] = None):
        details = {}
        if auth_type:
...
class AuthorizationError(BlacklistError):
    ...
    def __init__(self, message: str, user_id: Optional[str] = None, 
                 required_role: Optional[str] = None, resource: Optional[str] = None):
        details = {}
        if user_id:
            details['user_id'] = user_id
        if required_role:
...
class DataProcessingError(BlacklistError):
    ...
    def __init__(self, message: str, file_path: Optional[str] = None, 
                 operation: Optional[str] = None, data_type: Optional[str] = None):
        details = {}
        if file_path:
...
class ConnectionError(BlacklistError):
    ...
    def __init__(self, message: str, url: Optional[str] = None, 
                 timeout: Optional[int] = None, status_code: Optional[int] = None):
        details = {}
        if url:
            details['url'] = url
...
class ServiceUnavailableError(BlacklistError):
    ...
    def __init__(self, message: str, service_name: Optional[str] = None, 
                 retry_after: Optional[int] = None, status_code: Optional[int] = None):
        details = {}
        if service_name:
...
def log_exception(exc: Exception, logger_instance: Optional[logging.Logger] = None):
    ...
    if isinstance(exc, BlacklistError):
        log.error(f"{exc.error_code}: {exc.message}", extra={
