...
class IPSourceManager:
    ...
    def __init__(self, db_manager: DatabaseManager, config_file: str = "config/sources.json"):
    ...
    def update_all_sources(self, max_workers: int = 5) -> Dict[str, Any]:
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            # 비동기 작업 제출
            future_to_source = {
                executor.submit(source.update): name 
        ...
        summary = {
            ...
            "successful_sources": len([r for r in results.values() if r["status"] == "success"]),
        ...
        logger.info(f"Update completed: {summary['successful_sources']}/{summary['total_sources']} sources, {total_entries} entries")
