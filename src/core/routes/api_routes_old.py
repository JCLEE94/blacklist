...
500줄 제한으로 인해 기능별로 분할된 라우트들을 임포트
"""
...
from .blacklist_routes import get_active_blacklist
from .blacklist_routes import get_enhanced_blacklist
from .blacklist_routes import get_fortigate_format
    ...
    return jsonify(
        {
            ...
            "api_endpoints": {
                ...
                "enhanced_blacklist": "/api/v2/blacklist/enhanced",
            },
        }
    )


# service_status 함수는 health_routes.py로 이동됨
# detailed_health_check로 이름 변경 및 기능 향상

# 이 파일은 이제 라우트 통합 관리자 역할만 수행
# 실제 라우트 구현은 각 전용 모듈에서 담당
