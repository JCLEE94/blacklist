...
# Blueprint 생성
cookie_collection_bp = Blueprint('cookie_collection', __name__, url_prefix='/api/collection/cookie')
                ...
                for ip_data in collected_data:
                    try:
                        blacklist_manager.add_ip(
                            ...
                            description=ip_data.get('description', 'Cookie-based collection'),
    ...
    try:
        ...
        try:
            ...
            if 'regtech' in service._components:
                ...
                status['session_cookies'] = len(getattr(collector, 'session_cookies', {}))
