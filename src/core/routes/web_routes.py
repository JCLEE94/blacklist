...
This module provides web interface endpoints for dashboards, pages, and UI components.
Includes dashboard rendering, statistics pages, and data visualization endpoints.
"""

from ..common.imports import Blueprint, jsonify, redirect, render_template, url_for, logger
...
def collection_control():
    """수집 제어 패널 페이지 - 메인 대시보드로 리디렉션"""
    return redirect(url_for("unified.web_routes.dashboard"))
...
# Statistics routes moved to web_stats_routes.py for file size compliance
