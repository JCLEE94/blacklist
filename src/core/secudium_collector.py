...
class SecudiumCollector(BaseCollector):
    ...
    def __init__(self, config: CollectionConfig):
        ...
        self.logger.warning("SECUDIUM Collector initialized but disabled due to account issues")
    ...
    async def _collect_bulletin_data(self, session: requests.Session) -> List[Dict[str, Any]]:
        """게시판 데이터 수집 (구현 대기)"""
        # 실제 구현 시 활성화
        return []
