        ...
        try:
            ...
            return {
                ...
                "details": {
                    ...
                    "data_availability": "available" if active_ips > 0 else "unavailable",
                    "source_diversity": len([k for k, v in health.get("sources", {}).items() if v > 0]),
                }
            }
...
if __name__ == "__main__":
    ...
    try:
        ...
        mixin_methods = [method for method in dir(SystemHealthMixin) 
    ...
    try:
        ...
        if not expected_keys.issubset(result.keys()):
            ...
            all_validation_failures.append(f"Health check structure: Missing keys {missing}")
    ...
    try:
        class MockHealthMixin(SystemHealthMixin):
            ...
            def get_system_health(self):
                return {"status": "healthy", "active_ips": 100, "db_status": "connected"}
