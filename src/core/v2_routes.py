...
def init_v2_services(blacklist_manager, cache_manager):
    ...
    from .v2_routes.analytics_routes import init_service as init_analytics_service
    from .v2_routes.blacklist_routes import init_service as init_blacklist_service
    from .v2_routes.export_routes import init_service as init_export_service
    from .v2_routes.health_routes import init_service as init_health_service
