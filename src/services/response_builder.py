...
class ResponseBuilder:
    ...
    @staticmethod
    def validation_error(message: Union[str, Dict], 
    ...
    @staticmethod
    def fortigate(ips: List[str], category: str = "Blacklist",
    ...
    @staticmethod
    def batch_result(results: List[Dict], success_count: int,
                    failure_count: int, metadata: Optional[Dict] = None) -> Response:
        """
