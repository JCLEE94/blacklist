...
class EnhancedSmartCache:
    ...
    def __init__(
        ...
        self.primary_backend = (
            self.redis_backend if self.redis_backend.is_available 
            else self.memory_backend
        )
        
        logger.info(f"EnhancedSmartCache initialized with {self.primary_backend.__class__.__name__} backend")
    ...
    def get(self, key: str) -> Any:
        ...
        try:
            ...
            if raw_data is None:
                ...
                self.performance.record_operation("get", time.time() - start_time, success=True)
                return None
            ...
            self.performance.record_operation("get", time.time() - start_time, success=False)
            return None
    ...
    def set(
        ...
        try:
            ...
            if success and tags and hasattr(self.primary_backend, 'is_available') and self.primary_backend.is_available:
                self._handle_tags(key, tags)
            
            self.performance.record_operation("set", time.time() - start_time, success=success)
            return success
            
        except Exception as e:
            logger.error(f"Cache SET error for key '{key}': {e}")
            self.performance.record_operation("set", time.time() - start_time, success=False)
            return False
    ...
    def delete(self, key: str) -> bool:
        ...
        try:
            ...
            self.performance.record_operation("delete", time.time() - start_time, success=success)
            return success
            
        except Exception as e:
            logger.error(f"Cache DELETE error for key '{key}': {e}")
            self.performance.record_operation("delete", time.time() - start_time, success=False)
            return False
    ...
    def delete_pattern(self, pattern: str) -> int:
        ...
        try:
            ...
            self.performance.record_operation("delete_pattern", time.time() - start_time, success=True)
            return deleted_count
            
        except Exception as e:
            logger.error(f"Cache DELETE PATTERN error for pattern '{pattern}': {e}")
            self.performance.record_operation("delete_pattern", time.time() - start_time, success=False)
            return 0
    ...
    def clear(self) -> bool:
        ...
        try:
            ...
            self.performance.record_operation("clear", time.time() - start_time, success=success)
            return success
            
        except Exception as e:
            logger.error(f"Cache CLEAR error: {e}")
            self.performance.record_operation("clear", time.time() - start_time, success=False)
            return False
    ...
    def exists(self, key: str) -> bool:
        ...
        try:
            ...
            self.performance.record_operation("exists", time.time() - start_time, success=True)
            return exists
            
        except Exception as e:
            logger.error(f"Cache EXISTS error for key '{key}': {e}")
            self.performance.record_operation("exists", time.time() - start_time, success=False)
            return False
    ...
    def _handle_tags(self, key: str, tags: List[str]):
        ...
        if hasattr(self.redis_backend, 'is_available') and self.redis_backend.is_available:
            try:
    ...
    def invalidate_tags(self, tags: List[str]) -> int:
        ...
        if not (hasattr(self.redis_backend, 'is_available') and self.redis_backend.is_available):
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        is_healthy = (
            ...
            performance_summary.get("error_rate_percent", 0) < 5
        )
        ...
        return {
            ...
            "performance": {
                ...
                "average_response_time_ms": performance_summary.get("average_operation_time_ms", 0),
                "error_rate_percent": performance_summary.get("error_rate_percent", 0),
                "operations_per_second": performance_summary.get("recent_ops_per_second", 0),
            },
