...
class MetricsCollector:
    ...
    def get_app_metrics(self) -> Dict[str, Any]:
        ...
        metrics = {
            ...
            'cache': {
                'hits': self.counters.get('cache:hit:redis', 0) + self.counters.get('cache:hit:memory', 0),
                'misses': self.counters.get('cache:miss:redis', 0) + self.counters.get('cache:miss:memory', 0)
            }
        }
