...
class PerformanceCache:
    ...
    def __init__(self, config: CacheConfig = None, redis_client=None):
        ...
        self.cache_stats = {
            ...
            "memory_hits": 0, "redis_hits": 0, "compression_saves": 0
        }
        ...
        logger.info(f"PerformanceCache initialized with Redis: {self.redis_client is not None}")
                ...
                try:
                    ...
                    if data:
                        ...
                        if value is not None:
                            ...
                            # 메모리 캐시에 백업 저장
                            self._set_memory_cache(cache_key, value, self.config.default_ttl)
                            return value
                except Exception as e:
