...
class SecurityManager:
    ...
    def generate_jwt_token(self, user_id: str, roles=None, expires_hours: int = 24) -> str:
    ...
    def record_failed_attempt(self, identifier: str, max_attempts: int = 5, lockout_minutes: int = 15) -> bool:
        return self.rate_manager.record_failed_attempt(identifier, max_attempts, lockout_minutes)
