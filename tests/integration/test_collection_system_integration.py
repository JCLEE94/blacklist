...
def test_collection_manager_initialization():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert manager.collection_enabled == False, "Collection should be disabled by default"
        ...
        assert manager2.collection_enabled == True, "Environment variable should override"
...
def test_unified_service_integration():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            assert hasattr(service, 'blacklist_manager'), "Should have blacklist_manager"
            assert hasattr(service, 'collection_manager'), "Should have collection_manager"
