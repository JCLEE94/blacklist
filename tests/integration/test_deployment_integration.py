    ...
    for script_name in important_scripts:
        ...
        if script_path.exists():
            ...
            with open(script_path, 'r') as f:
                ...
                assert first_line.startswith('#!/bin/bash'), f"{script_name} missing shebang"
...
def test_registry_configuration():
    ...
    using_private_registry = any('registry.jclee.me' in config for config in registry_configs)
...
def test_health_probes():
    ...
    with open(deployment_path, 'r') as f:
        ...
        # 타이밍 검증
        assert readiness['initialDelaySeconds'] < liveness['initialDelaySeconds'], \
...
def test_resource_limits():
    ...
    with open(deployment_path, 'r') as f:
        ...
        print(f"✅ Resource requests: CPU={resources['requests']['cpu']}, Memory={resources['requests']['memory']}")
        ...
        print(f"✅ Resource limits: CPU={resources['limits']['cpu']}, Memory={resources['limits']['memory']}")
...
def test_hpa_configuration():
    ...
    if hpa_path.exists():
        with open(hpa_path, 'r') as f:
            ...
            print(f"✅ HPA configured: min={spec['minReplicas']}, max={spec['maxReplicas']}")
    else:
