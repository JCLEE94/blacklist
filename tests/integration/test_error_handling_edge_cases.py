...
class TestErrorHandlingIntegration:
    ...
    def test_network_timeout_handling(self, client, failing_service):
        ...
        failing_service.trigger_regtech_collection.side_effect = failing_service.network_error
    ...
    def test_database_corruption_handling(self, client):
        ...
        mock_service = Mock()
        mock_service.get_system_health.side_effect = sqlite3.DatabaseError("Database disk image is malformed")
    ...
    def test_malformed_response_handling(self, client):
        ...
        mock_service.trigger_regtech_collection.return_value = "Not a dict"  # Wrong type
        mock_service.add_collection_log.return_value = None
    ...
    def test_invalid_date_format_handling(self, client):
        ...
        mock_service = Mock()
        mock_service.trigger_regtech_collection.side_effect = ValueError("Invalid date format")
        mock_service.add_collection_log.return_value = None
    ...
    def test_memory_exhaustion_handling(self, client):
        ...
        mock_service.get_collection_status.side_effect = MemoryError("Cannot allocate memory")
    ...
    def test_large_response_handling(self, client):
        ...
        mock_service.get_system_health.return_value = {'total_ips': 100000, 'active_ips': 100000}
    ...
    def test_unicode_handling_in_errors(self, client):
        ...
        mock_service = Mock()
        mock_service.trigger_regtech_collection.side_effect = Exception("에러: 한글 오류 메시지 🚫")
        mock_service.add_collection_log.return_value = None
...
class TestEdgeCaseScenarios:
    ...
    def test_empty_database_scenario(self, client):
        ...
        mock_service = Mock()
        mock_service.get_collection_status.return_value = {'enabled': True, 'sources': {}}
        mock_service.get_daily_collection_stats.return_value = []
    ...
    def test_inverted_date_range(self, client):
        ...
        with patch('src.core.unified_routes.service', mock_service):
            response = client.post('/api/collection/regtech/trigger',
                                 json={
                                     'start_date': '20250630',
                                     'end_date': '20250601'  # Before start
                                 })
    ...
    def test_special_characters_in_requests(self, client):
        ...
        mock_service = Mock()
        mock_service.trigger_regtech_collection.return_value = {'success': True, 'collected': 0}
        mock_service.add_collection_log.return_value = None
