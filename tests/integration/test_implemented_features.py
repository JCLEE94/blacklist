...
# API 키 관리 테스트
from src.models.api_key import ApiKeyManager, ApiKey
...
class TestCollectorSystem:
    ...
    async def test_collection_cancellation(self):
        """수집 취소 기능 테스트"""
        from src.core.collectors.unified_collector import CollectionConfig, BaseCollector
...
class TestJWTTokenSystem:
    ...
    def test_jwt_token_expiration(self):
        ...
        # 매우 짧은 만료시간 (1초)
        token = manager.generate_jwt_token("test_user", ["user"], expires_hours=1/3600)
    ...
    def test_container_initialization(self):
        ...
        for service in services:
            try:
                ...
                # 서비스가 None이 아니면 성공
                print(f"Service {service}: {'Available' if service_instance else 'Not available'}")
