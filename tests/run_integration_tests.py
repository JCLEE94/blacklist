    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if healthy:
                ...
                return {
                    "passed": True,
                    "details": f"서비스 정상, IP 수: {total_ips:,}개"
                }
            else:
                return {
                    "passed": False,
                    "details": "서비스가 unhealthy 상태"
                }
        else:
            return {
                "passed": False,
...
def test_web_ui(base_url):
    ...
    return {
        "passed": passed,
        "details": f"{passed_pages}/{total_pages} 페이지 정상"
    }
...
def test_performance(base_url):
    ...
    return {
        "passed": passed,
        "details": f"평균 응답시간: {avg_response_time:.0f}ms"
    }
...
def test_functionality(base_url):
    ...
    return {
        "passed": passed,
        "details": f"{passed_functions}/{total_functions} 기능 정상"
    }
