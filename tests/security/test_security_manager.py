...
class TestSecurityManager:
    ...
    def test_hash_password_with_salt(self):
        ...
        password_hash, returned_salt = self.security_manager.hash_password(
            password, salt
        )
    ...
    def test_verify_password_incorrect(self):
        ...
        result = self.security_manager.verify_password(
    ...
    def test_verify_password_with_exception(self):
        ...
        with patch.object(
            self.security_manager, "hash_password", side_effect=Exception("Hash error")
        ):
    ...
    def test_generate_jwt_token_with_custom_expiry(self):
        ...
        token = self.security_manager.generate_jwt_token(
            user_id, expires_hours=expires_hours
        )
    ...
    def test_check_rate_limit_window_reset(self):
        ...
        result = self.security_manager.check_rate_limit(
    ...
    def test_unblock(self):
        ...
        self.security_manager.blocked_ips.add(identifier)
        self.security_manager.failed_attempts[identifier] = {
            "count": 5,
    ...
    def test_validate_api_key_format_invalid(self):
        ...
        invalid_keys = ["no_underscore", "short_key", "ak_", "ak_short", "", None, 123]
