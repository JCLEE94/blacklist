...
class TestCollectionStatusAPI:
    ...
    def test_collection_daily_stats(self):
        ...
        response = requests.get(
            f"{self.BASE_URL}/api/collection/daily-stats?days=7", timeout=10
        )
    ...
    def test_collection_history(self):
        ...
        response = requests.get(
            f"{self.BASE_URL}/api/collection/history?limit=10&offset=0", timeout=10
        )
    ...
    def test_collection_history_limits(self):
        ...
        response = requests.get(
            f"{self.BASE_URL}/api/collection/history?limit=150", timeout=10
        )
...
class TestCollectionTriggers:
    ...
    def test_regtech_trigger_validation(self):
        ...
        response = requests.post(
            f"{self.BASE_URL}/api/collection/regtech/trigger",
            json={"start_date": "invalid-date", "end_date": "20250117"},
            timeout=10,
        )
        ...
        # Test missing dates
        response = requests.post(
            f"{self.BASE_URL}/api/collection/regtech/trigger", json={}, timeout=10
        )
    ...
    def test_secudium_collection_disabled(self):
        ...
        response = requests.post(
            f"{self.BASE_URL}/api/collection/secudium/trigger", timeout=10
        )
        ...
        assert (
            ...
            or "disabled" in data.get("message", "").lower()
        )
...
class TestCollectionDataPipeline:
    ...
    def test_fortigate_endpoint(self):
        ...
        if content.strip():
            ...
            assert (
                any(
                    keyword in content
                    for keyword in ["config", "edit", "set", "next", "end"]
                )
                or content.strip() == ""
            )
    ...
    def test_enhanced_blacklist_v2(self):
        ...
        response = requests.get(
            f"{self.BASE_URL}/api/v2/blacklist/enhanced", timeout=10
        )
...
class TestCollectionAnalytics:
    ...
    def test_analytics_summary(self):
        ...
        response = requests.get(
            f"{self.BASE_URL}/api/v2/analytics/summary?period=7d", timeout=10
        )
...
class TestCollectionErrorHandling:
    ...
    def test_invalid_date_ranges(self):
        ...
        response = requests.post(
            f"{self.BASE_URL}/api/collection/regtech/trigger",
            json={"start_date": future_date, "end_date": future_date},
            timeout=10,
        )
        ...
        response = requests.post(
            f"{self.BASE_URL}/api/collection/regtech/trigger",
            json={"start_date": "20250117", "end_date": "20250101"},
            timeout=10,
        )
    ...
    def test_concurrent_collection_requests(self):
        ...
        def trigger_collection():
            try:
                response = requests.post(
                    f"{self.BASE_URL}/api/collection/regtech/trigger",
                    json={"start_date": "20250101", "end_date": "20250102"},
                    timeout=15,
                )
...
class TestCollectionPerformance:
    ...
    def test_large_date_range_handling(self):
        ...
        response = requests.get(
            f"{self.BASE_URL}/api/collection/daily-stats?days=90", timeout=15
        )
