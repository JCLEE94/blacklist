...
class TestCollectionManagerInit:
    ...
    def test_services_initialization(self):
        ...
        with patch('src.core.collection_manager.manager.CollectionConfigService') as mock_config, \
             patch('src.core.collection_manager.manager.ProtectionService') as mock_protection, \
...
class TestCollectionManagerServices:
    ...
    def create_manager_with_mocks(self):
        ...
        with patch('src.core.collection_manager.manager.CollectionConfigService', return_value=self.mock_config_service), \
             patch('src.core.collection_manager.manager.ProtectionService', return_value=self.mock_protection_service), \
             patch('src.core.collection_manager.manager.AuthService', return_value=self.mock_auth_service), \
             patch('src.core.collection_manager.manager.StatusService', return_value=self.mock_status_service):
...
class TestCollectionManagerErrorHandling:
    ...
    def test_service_initialization_failure(self):
        ...
        with patch('src.core.collection_manager.manager.CollectionConfigService', side_effect=Exception("Config service failed")):
    ...
    def test_protection_service_failure(self):
        ...
        with patch('src.core.collection_manager.manager.CollectionConfigService'), \
             patch('src.core.collection_manager.manager.ProtectionService', side_effect=Exception("Protection failed")):
    ...
    def test_auth_service_failure(self):
        ...
        with patch('src.core.collection_manager.manager.CollectionConfigService'), \
             patch('src.core.collection_manager.manager.ProtectionService'), \
             patch('src.core.collection_manager.manager.AuthService', side_effect=Exception("Auth failed")):
    ...
    def test_status_service_failure(self):
        ...
        with patch('src.core.collection_manager.manager.CollectionConfigService'), \
             patch('src.core.collection_manager.manager.ProtectionService'), \
             patch('src.core.collection_manager.manager.AuthService'), \
             patch('src.core.collection_manager.manager.StatusService', side_effect=Exception("Status failed")):
