...
from src.core.collectors.unified_collector import CollectionConfig, CollectionResult, CollectionStatus
...
class TestRegtechCollector:
    ...
    def test_error_recovery(self):
        ...
        async def run_test():
            ...
            with patch.object(self.collector, '_collect_data', side_effect=intermittent_failure):
                result = await self.collector.collect()
                return result, call_count
