...
class TestCommonModule:
    ...
    def test_common_path_utilities(self):
        ...
        try:
            from src.common import get_project_root, get_config_dir, get_data_dir
    ...
    def test_common_validation_helpers(self):
        ...
        try:
            from src.common import validate_ip, validate_email, validate_url
    ...
    def test_common_string_utilities(self):
        ...
        try:
            from src.common import sanitize_string, normalize_whitespace, truncate_string
    ...
    def test_common_date_utilities(self):
        ...
        try:
            from src.common import format_datetime, parse_datetime, get_current_timestamp
