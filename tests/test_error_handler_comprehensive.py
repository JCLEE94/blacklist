...
class TestErrorValidation:
    ...
    def test_validate_ip_format(self):
        ...
        try:
            ...
            # Test invalid IPs
            assert validate_ip_format("256.1.1.1") == False
...
class TestSpecificErrorTypes:
    ...
    def test_external_service_error(self):
        ...
        try:
            ...
            error = ExternalServiceError("API call failed", service="REGTECH", status_code=500)
...
if __name__ == "__main__":
    ...
    total_tests += 1
    try:
        from src.utils.error_handler import ErrorHandler, BaseError
