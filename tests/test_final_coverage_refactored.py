...
class TestRefactoredModules:
    ...
    def test_backward_compatibility(self):
        ...
        try:
            ...
            from src.core.routes.api_routes import health_check, get_active_blacklist
...
class TestCodeQuality:
    ...
    def test_no_duplicate_code(self):
        ...
        try:
            ...
            from src.core.routes.blacklist_routes import get_active_blacklist as blacklist_func
        ...
        for file_path in files_to_check:
            if os.path.exists(file_path):
                with open(file_path, 'r') as f:
                    ...
                    assert len(import_lines) == len(unique_imports), f"Duplicate imports found in {file_path}"
