...
class TestMonthData:
    ...
    def test_post_init_with_detection_date(self):
        ...
        month_data = MonthData(month="2023-12", detection_date="2023-12-01T00:00:00Z")

        assert month_data.expiry_date is not None
        assert (
            "2024-02-29" in month_data.expiry_date
            or "2024-03-01" in month_data.expiry_date
        )
    ...
    def test_post_init_expired_date(self, mock_datetime):
        ...
        month_data = MonthData(month="2023-01", detection_date="2023-01-01T00:00:00Z")
    ...
    def test_post_init_invalid_date(self):
        ...
        month_data = MonthData(month="2023-12", detection_date="invalid-date")
    ...
    def test_to_dict(self):
        ...
        month_data = MonthData(
            month="2023-11", ip_count=100, total_detections=150, unique_sources=3
        )
...
class TestSystemHealth:
    ...
    def test_custom_creation(self):
        ...
        health = SystemHealth(
            status=HealthStatus.HEALTHY, timestamp=custom_time, version="1.0.0"
        )
    ...
    def test_add_component(self):
        ...
        component = ComponentStatus(
            name="database", status=HealthStatus.HEALTHY, details={"connection": "ok"}
        )
...
class TestMetricsModels:
    ...
    def test_cache_metrics(self):
        ...
        metrics = CacheMetrics(
            hit_rate=0.85, miss_rate=0.15, total_hits=850, total_misses=150
        )
    ...
    def test_collection_metrics(self):
        ...
        metrics = CollectionMetrics(
            total_collections=100, successful_collections=95, failed_collections=5
        )
    ...
    def test_security_metrics(self):
        ...
        metrics = SecurityMetrics(
            total_events=1000, critical_events=10, warning_events=50, info_events=940
        )
    ...
    def test_system_metrics(self):
        """SystemMetrics 테스트"""
        metrics = SystemMetrics(cpu_usage=75.5, memory_usage=60.2, disk_usage=40.0)
    ...
    def test_source_metrics(self):
        ...
        metrics = SourceMetrics(
            source_name="regtech", total_ips=500, active_ips=450, expired_ips=50
        )
    ...
    def test_database_metrics(self):
        ...
        metrics = DatabaseMetrics(
            total_records=10000, active_records=9500, expired_records=500
        )
...
class TestDataValidationResult:
    ...
    def test_valid_result(self):
        ...
        result = DataValidationResult(
            is_valid=True, data={"ip": "192.168.1.1"}, message="Validation successful"
        )
...
class TestServiceStatus:
    ...
    def test_basic_creation(self):
        ...
        status = ServiceStatus(
            name="blacklist-service", status=HealthStatus.HEALTHY, version="1.0.0"
        )
...
class TestComponentStatus:
    ...
    def test_basic_creation(self):
        """기본 생성 테스트"""
        component = ComponentStatus(name="redis-cache", status=HealthStatus.HEALTHY)
...
class TestSecurityEvent:
    ...
    def test_basic_creation(self):
        """기본 생성 테스트"""
        event = SecurityEvent(
            event_type=SecurityEventType.LOGIN_ATTEMPT, description="User login attempt"
        )
