...
class TestModels:
    ...
    def test_model_attribute_access(self):
        ...
        entry = BlacklistEntry(ip="1.1.4.1", source="TEST")
    ...
    def test_model_with_none_values(self):
        ...
        entry = BlacklistEntry(
            ip="1.1.4.1", source="TEST", country=None, attack_type=None
        )
...
class TestIntegrationScenarios:
    ...
    def test_pipeline_with_security(self):
        ...
        try:
            ...
            # Process some data
            test_data = [{"ip": "1.1.4.1", "source": "TEST"}]
