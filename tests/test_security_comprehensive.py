...
class TestSecurityAuth:
    ...
    def test_jwt_token_expiration(self):
        ...
        token = auth_mgr.generate_jwt_token(
...
class TestSecurityRateLimiting:
    ...
    def test_rate_limiter_import(self):
        ...
        from src.utils.security.rate_limiting import RateLimiter, rate_limit
    ...
    def test_rate_limiter_creation(self):
        ...
        rate_limiter = RateLimiter(
            max_requests=10, time_window=60, storage="memory"  # 60 seconds
        )
...
class TestSecurityEncryption:
    ...
    def test_encryption_functions(self):
        ...
        try:
            from src.utils.security.auth import decrypt_data, encrypt_data
