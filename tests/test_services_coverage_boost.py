...
class TestBlacklistUnifiedServices:
    ...
    def test_expiration_service(self):
        ...
        try:
            ...
            with patch('src.core.blacklist_unified.expiration_service.DatabaseManager') as mock_db:
    ...
    def test_search_service(self):
        ...
        try:
            ...
            with patch('src.core.blacklist_unified.search_service.DatabaseManager') as mock_db:
    ...
    def test_statistics_service(self):
        ...
        try:
            ...
            with patch('src.core.blacklist_unified.statistics_service.DatabaseManager') as mock_db:
    ...
    def test_unified_collector(self):
        ...
        try:
            ...
            if hasattr(collector, 'collect_all'):
                with patch('src.core.collectors.unified_collector.RegtechCollector') as mock_regtech:
                    with patch('src.core.collectors.unified_collector.SecudiumCollector') as mock_secudium:
                        mock_regtech.return_value.collect.return_value = ['192.168.1.1']
                        mock_secudium.return_value.collect.return_value = ['192.168.1.2']
...
class TestMonitoringModules:
    ...
    def test_collection_metrics(self):
        ...
        try:
            from src.core.monitoring.mixins.collection_metrics import CollectionMetricsMixin
