...
class TestDecoratorsModules:
    ...
    def test_auth_decorators(self):
        ...
        try:
            from src.utils.decorators.auth import require_auth, require_admin
    ...
    def test_cache_decorators(self):
        ...
        try:
            from src.utils.decorators.cache import cached, cache_clear
    ...
    def test_convenience_decorators(self):
        ...
        try:
            from src.utils.decorators.convenience import timing, log_errors
