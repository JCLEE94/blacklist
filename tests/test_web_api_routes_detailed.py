...
class TestApiStatsFunction:
    ...
    @patch('builtins.open', new_callable=mock_open, read_data='{"total_ips": 100, "active_ips": 50}')
    ...
    @patch('src.web.api_routes.json.load', side_effect=json.JSONDecodeError("Invalid JSON", "", 0))
    @patch('src.web.api_routes.Path')
