...
class TestAnalyticsRoutes:
    ...
    def test_get_system_stats_exception(self, client, mock_service):
        ...
        with mock.patch('src.core.routes.analytics_routes.service', mock_service):
            with mock.patch('src.core.routes.analytics_routes.create_error_response', return_value={'error': 'Health error'}):
                response = client.get('/api/stats')
    ...
    def test_get_blacklist_with_metadata_exception(self, client):
        ...
        with mock.patch('sqlite3.connect', side_effect=Exception("DB error")):
            with mock.patch('src.core.routes.analytics_routes.create_error_response', return_value={'error': 'DB error'}):
                response = client.get('/api/blacklist/metadata')
    ...
    def test_v2_get_threat_levels_exception(self, client, mock_v2_service):
        ...
        mock_v2_service.get_threat_level_analysis.side_effect = Exception("Threat error")
    ...
    def test_v2_get_trend_analysis_success(self, client, mock_v2_service):
        ...
        with mock.patch('src.core.v2_routes.analytics_routes.service', mock_v2_service):
            ...
            assert data['trend_analysis']['direction'] in ['increasing', 'decreasing', 'stable', 'insufficient_data']
    ...
    def test_v2_get_trend_analysis_with_days(self, client, mock_v2_service):
        ...
        with mock.patch('src.core.v2_routes.analytics_routes.service', mock_v2_service):
            ...
            mock_v2_service.blacklist_manager.get_daily_trend_data.assert_called_with(60)
    ...
    def test_v2_get_trend_analysis_exception(self, client, mock_v2_service):
        ...
        mock_v2_service.blacklist_manager.get_daily_trend_data.side_effect = Exception("Trend error")
    ...
    def test_v2_get_source_analysis_exception(self, client, mock_v2_service):
        ...
        mock_v2_service.blacklist_manager.get_stats_for_period.side_effect = Exception("Source error")
    ...
    def test_v2_get_geo_analysis_with_limit(self, client, mock_v2_service):
        ...
        with mock.patch('src.core.v2_routes.analytics_routes.service', mock_v2_service):
            ...
            assert response.status_code == 200
            mock_v2_service.blacklist_manager.get_country_statistics.assert_called_with(10)

    def test_v2_get_geo_analysis_continental_distribution(self, client, mock_v2_service):
    ...
    def test_v2_get_geo_analysis_exception(self, client, mock_v2_service):
        ...
        mock_v2_service.blacklist_manager.get_country_statistics.side_effect = Exception("Geo error")
