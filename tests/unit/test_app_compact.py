...
class TestCompactFlaskApp:
    ...
    def test_setup_advanced_features(self, mock_init_decorators, mock_security, 
                                    mock_cache, mock_get_container):
...
class TestMainFunction:
    ...
    def test_main_with_development_env(self, mock_env_get, mock_load_dotenv, mock_create_app):
        ...
        with patch('src.core.app_compact.Path') as mock_path:
            ...
            mock_path.return_value.parent.parent.__truediv__.return_value = mock_env_file
    ...
    @patch('dotenv.load_dotenv')
    @patch('src.core.app_compact.os.environ.get')
    def test_main_with_production_env(self, mock_env_get, mock_load_dotenv, mock_create_app):
    ...
    @patch('dotenv.load_dotenv')
    @patch('src.core.app_compact.os.environ.get')
    def test_main_with_failed_app(self, mock_env_get, mock_load_dotenv, mock_create_app):
