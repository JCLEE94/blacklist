...
class TestCollectionRoutes:
    ...
    def mock_service(self):
        ...
        service.get_collection_status.return_value = {
            ...
            'sources': {'regtech': {'available': True}, 'secudium': {'available': False}},
            'last_updated': datetime.now().isoformat()
        }
        service.get_daily_collection_stats.return_value = [
            {'date': datetime.now().strftime('%Y-%m-%d'), 'count': 10, 'sources': {'regtech': 10}}
        ]
    ...
    def test_get_collection_status_success(self, client, mock_service):
        ...
        with mock.patch('src.core.routes.collection_status_routes.service', mock_service):
    ...
    def test_enable_collection_success(self, client, mock_service, mock_container):
        ...
        with mock.patch('src.core.routes.collection_status_routes.service', mock_service):
            with mock.patch('src.core.routes.collection_status_routes.get_container', return_value=mock_container):
    ...
    def test_collection_statistics_exception(self, client, mock_service):
        ...
        with mock.patch('src.core.routes.collection_status_routes.service', mock_service):
            with mock.patch('src.core.routes.collection_status_routes.create_error_response', return_value={'error': 'Stats error'}):
                response = client.get('/api/collection/statistics')
    ...
    def test_update_collection_intervals_success(self, client, mock_service):
        ...
        with mock.patch('src.core.routes.collection_status_routes.service', mock_service):
            response = client.post('/api/collection/intervals', 
    ...
    def test_trigger_regtech_collection_success(self, client, mock_service, mock_container):
        ...
        with mock.patch('src.core.routes.collection_trigger_routes.service', mock_service):
            with mock.patch('src.core.routes.collection_trigger_routes.get_container', return_value=mock_container):
    ...
    def test_trigger_regtech_collection_failure(self, client, mock_service, mock_container):
    ...
    def test_trigger_regtech_collection_exception(self, client, mock_service, mock_container):
    ...
    def test_trigger_secudium_collection_disabled(self, client, mock_service, mock_container):
    ...
    def test_trigger_secudium_collection_exception(self, client, mock_service, mock_container):
    ...
    def test_get_collection_progress_success(self, client, mock_service, mock_container):
    ...
    def test_get_collection_progress_no_progress(self, client, mock_service, mock_container):
    ...
    def test_api_collection_logs_with_file(self, client, mock_service):
        ...
        with mock.patch('os.path.exists', return_value=True):
            with mock.patch('builtins.open', mock.mock_open(read_data=''.join(log_content))):
                with mock.patch('src.core.routes.collection_logs_routes.service', mock_service):
                    response = client.get('/api/collection/logs')
