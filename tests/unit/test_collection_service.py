...
class TestCollectionServiceMixin:
    ...
    @pytest.mark.asyncio
    async def test_collect_all_data_success(self, service, mock_regtech_component, mock_secudium_component):
    ...
    @pytest.mark.asyncio
    async def test_collect_all_data_partial_failure(self, service, mock_regtech_component, mock_secudium_component):
        """Test collection with one source failing"""
        mock_regtech_component.auto_collect.return_value = {'success': False, 'error': 'Connection failed'}
    ...
    @pytest.mark.asyncio
    async def test_collect_all_data_component_exception(self, service, mock_regtech_component):
    ...
    @pytest.mark.asyncio
    async def test_collect_regtech_data_with_date(self, service, mock_regtech_component):
        """Test REGTECH data collection with date range"""
        service._components = {'regtech': mock_regtech_component}
        
        result = await service._collect_regtech_data_with_date("2023-01-01", "2023-01-31")
    ...
    def test_enable_collection_failure(self, service):
        ...
        service.clear_all_database_data = mock.Mock(side_effect=Exception("Clear failed"))
    ...
    def test_trigger_regtech_collection_with_dates(self, service, mock_regtech_component):
    ...
    def test_trigger_regtech_collection_default_dates(self, service, mock_regtech_component):
    ...
    def test_trigger_regtech_collection_exception(self, service, mock_regtech_component):
        """Test REGTECH collection trigger with exception"""
        service.collection_enabled = True
        service._components = {'regtech': mock_regtech_component}
        mock_regtech_component.collect_from_web.side_effect = Exception("Collection error")
    ...
    def test_trigger_secudium_collection_success(self, service, mock_secudium_component):
    ...
    def test_has_data_for_date_exception(self, service):
        ...
        service.blacklist_manager.search_data = mock.Mock(side_effect=Exception("DB error"))
