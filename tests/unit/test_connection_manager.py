...
class TestConnectionManager:
    ...
    def test_get_connection_file_database(self, temp_db_path):
        ...
        with mock.patch('sqlite3.connect') as mock_connect:
            ...
            with mock.patch.object(manager, '_configure_file_connection') as mock_configure:
    ...
    def test_get_connection_memory_database_first_time(self):
        ...
        with mock.patch('sqlite3.connect') as mock_connect:
            ...
            with mock.patch.object(manager, '_configure_memory_connection') as mock_configure:
                conn = manager.get_connection()
