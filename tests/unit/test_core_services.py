...
class MockUnifiedService:
    ...
    def trigger_secudium_collection(self, start_date=None, end_date=None):
        return {
            'success': True,
            'items_collected': 15,
            'items_new': 3,
    ...
    def get_enhanced_blacklist_data(self, page=1, limit=100):
        return {
            'entries': self.get_blacklist_data(),
            'total': len(self.blacklist_data),
            'page': page,
            'limit': limit,
            'metadata': {
    ...
    def get_trends_analysis(self, days=7):
        return {
            'daily_counts': [10, 12, 15, 8, 20, 18, 25],
    ...
    def get_analytics_summary(self, period='7d'):
        return {
            'total_entries': 1000,
            'active_entries': 950,
            'inactive_entries': 50,
...
class MockBlacklistManager:
    ...
    def add_ip(self, ip_address, source, metadata=None):
        entry = {
    ...
    def remove_ip(self, ip_address):
        self.entries = [e for e in self.entries if e['ip_address'] != ip_address]
        return True
...
class MockCollectionManager:
    ...
    def collect_from_regtech(self, start_date=None, end_date=None):
        return {
            'success': True,
            'items_collected': 30,
            'items_new': 10,
    ...
    def collect_from_secudium(self, start_date=None, end_date=None):
        return {
            'success': True,
            'items_collected': 20,
            'items_new': 5,
    ...
    def get_collection_logs(self, limit=100):
        return [
            {
...
class TestCoreServices:
    ...
    def test_service_integration(self, mock_unified_service, mock_blacklist_manager, mock_cache_manager):
        """서비스 통합 테스트"""
    ...
    def test_service_data_validation(self, mock_unified_service, mock_blacklist_manager):
        """서비스 데이터 유효성 검증 테스트"""
    ...
    def test_end_to_end_workflow(self, mock_unified_service, mock_blacklist_manager, 
                                 mock_cache_manager, mock_collection_manager):
