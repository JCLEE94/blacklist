...
class TestMigrationManager:
    ...
    def test_get_current_version_success(self):
        ...
        mock_session.execute.return_value.scalar.return_value = "1.3.0"
    ...
    def test_run_migrations_no_previous_version(self):
        ...
        migration_mgr.add_migration("1.3.0", up_func2)
    ...
    def test_run_migrations_with_previous_version(self):
        ...
        migration_mgr.add_migration("1.3.0", up_func2)  # Should run
