...
class TestTableDefinitions:
    ...
    def test_create_all_tables_success(self, mock_system_logs, mock_cache, 
                                       mock_system_status, mock_auth_attempts,
                                       mock_collection_logs, mock_blacklist_entries,
                                       mock_metadata, mock_conn):
        """모든 테이블 생성 성공 테스트"""
