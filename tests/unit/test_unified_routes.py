...
from src.core.unified_routes import unified_bp, configure_routes
...
class TestUnifiedRoutes:
    ...
    def test_blueprint_registration_calls(self, mock_admin, mock_collection, 
                                        mock_analytics, mock_export, 
                                        mock_api, mock_web):
